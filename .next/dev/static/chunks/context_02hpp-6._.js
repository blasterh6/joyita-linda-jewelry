...
"use client";
;
const API_URL = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_API_URL || '/api/v1';
...
function CartProvider({ children }) {
    ...
    const [discountRules, setDiscountRules] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const activeDiscount = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "CartProvider.useMemo[activeDiscount]": ()=>{
            if (!user) return 0;
            const sortedRules = [
                ...discountRules
            ].sort({
                "CartProvider.useMemo[activeDiscount].sortedRules": (a, b)=>b.minAmount - a.minAmount
            }["CartProvider.useMemo[activeDiscount].sortedRules"]);
            const applicableRule = sortedRules.find({
                "CartProvider.useMemo[activeDiscount].applicableRule": (r)=>cartTotalRaw >= r.minAmount
            }["CartProvider.useMemo[activeDiscount].applicableRule"]);
...
_s(CartProvider, "X6hU07En6G6UuAS/8OOZ3MDdI8w=", false, function() {
    return [
                    ...
                    initial = [
                        {
                            id: '1',
                            title: 'Nueva Orden',
                            message: 'Se ha recibido la orden ORD-9901 para Carlos Cliente.',
                            type: 'order',
                            read: false,
                            time: 'Hace 5min'
                        },
                        {
                            ...
                            message: 'Un nuevo prospecto desea unirse como Vendedor.',
                            type: 'system',
                            read: false,
                            time: 'Hace 10min'
                        }
                    ...
                    initial = [
                        {
                            ...
                            message: 'Felicidades, has cerrado una venta de $1,850.00.',
                            type: 'sale',
                            read: false,
                            time: 'Hace 2min'
                        }
                    ...
                    initial = [
                        {
                            ...
                            message: 'Tu joyería está siendo empacada con amor.',
                            type: 'order',
                            read: false,
                            time: 'Hace 5min'
                        }
...
_s(NotificationProvider, "NEHWYK0RgReFeat3RLYlYaN42KQ=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"]
    ];
});
...
//# sourceMappingURL=context_02hpp-6._.js.map