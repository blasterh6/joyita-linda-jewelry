module.exports = [
"[project]/node_modules/mariadb/package.json.[json].mjs [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/mariadb/check-node.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$package$2e$json$2e5b$json$5d2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/package.json.[json].mjs [app-route] (ecmascript)");
//  SPDX-License-Identifier: LGPL-2.1-or-later
//  Copyright (c) 2015-2024 MariaDB Corporation Ab
'use strict';
;
function hasMinVersion(nodeVersionStr, connectorRequirement) {
...
const requirement = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$package$2e$json$2e5b$json$5d2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].engines.node;
...
"[project]/node_modules/mariadb/lib/const/error-code.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const __TURBOPACK__default__export__ = codes;
}),
"[project]/node_modules/mariadb/lib/misc/errors.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$error$2d$code$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/const/error-code.js [app-route] (ecmascript)");
//  SPDX-License-Identifier: LGPL-2.1-or-later
...
class SqlError extends Error {
    constructor(msg, sql, fatal, info, sqlState, errno, additionalStack, addHeader = undefined, cause){
        ...
        if (errno > 45000 && errno < 46000) {
            ...
            this.code = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$error$2d$code$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"][this.errno] || 'UNKNOWN';
        }
        if (additionalStack) {
...
function createError(msg, errno, info = null, sqlState = 'HY000', sql = null, fatal = false, additionalStack = undefined, addHeader = undefined, cause = undefined) {
...
function createFatalError(msg, errno, info = null, sqlState = '08S01', sql = null, additionalStack = undefined, addHeader = undefined) {
...
function getClientErrorKey(errno) {
...
"[project]/node_modules/mariadb/lib/io/packet.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/misc/errors.js [app-route] (ecmascript)");
//  SPDX-License-Identifier: LGPL-2.1-or-later
//  Copyright (c) 2015-2024 MariaDB Corporation Ab
'use strict';
;
 ...
 */ class Packet {
    ...
    readUInt32() {
        this.pos += 4;
        return this.buf[this.pos - 4] + (this.buf[this.pos - 3] << 8) + (this.buf[this.pos - 2] << 16) + this.buf[this.pos - 1] * 0x1000000;
    }
    readInt32() {
        this.pos += 4;
        return this.buf[this.pos - 4] + (this.buf[this.pos - 3] << 8) + (this.buf[this.pos - 2] << 16) + (this.buf[this.pos - 1] << 24);
    }
    readBigInt64() {
   ...
   */ readError(info, sql, stack) {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createError"](msg, errno, info, sqlState, sql, fatal, stack);
    }
}
...
const __TURBOPACK__default__export__ = Packet;
}),
"[project]/node_modules/mariadb/lib/io/packet-node-encoded.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$io$2f$packet$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/io/packet.js [app-route] (ecmascript)");
//  SPDX-License-Identifier: LGPL-2.1-or-later
//  Copyright (c) 2015-2024 MariaDB Corporation Ab
'use strict';
;
class PacketNodeEncoded extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$io$2f$packet$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"] {
...
const __TURBOPACK__default__export__ = PacketNodeEncoded;
}),
"[project]/node_modules/mariadb/lib/io/packet-node-iconv.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
class PacketIconvEncoded extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$io$2f$packet$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"] {
    constructor(encoding){
        super();
    ...
    readStringLengthEncoded() {
        ...
        if (len === null) return null;
        this.pos += len;
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$iconv$2d$lite$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].decode(this.buf.subarray(this.pos - len, this.pos), this.encoding);
    }
    static readString(encoding, buf, beg, len) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$iconv$2d$lite$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].decode(buf.subarray(beg, beg + len), encoding);
    }
    subPacketLengthEncoded(len) {
        this.skip(len);
    ...
    readStringRemaining() {
        const str = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$iconv$2d$lite$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].decode(this.buf.subarray(this.pos, this.end), this.encoding);
        this.pos = this.end;
        return str;
    }
}
const __TURBOPACK__default__export__ = PacketIconvEncoded;
}),
"[project]/node_modules/mariadb/lib/const/collations.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const __TURBOPACK__default__export__ = Collation;
}),
"[project]/node_modules/mariadb/lib/cmd/encoder/text-encoder.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const __TURBOPACK__default__export__ = TextEncoder;
}),
"[project]/node_modules/mariadb/lib/misc/utils.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/misc/errors.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$iconv$2d$lite$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/iconv-lite/lib/index.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$encoder$2f$text$2d$encoder$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/cmd/encoder/text-encoder.js [app-route] (ecmascript)");
//  SPDX-License-Identifier: LGPL-2.1-or-later
//  Copyright (c) 2015-2024 MariaDB Corporation Ab
'use strict';
;
...
function escapeId(opts, info, value) {
    if (!value || value === '') {
        throw __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createError"]('Cannot escape empty ID value', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_NULL_ESCAPEID, info, '0A000');
    }
    if (value.includes('\u0000')) {
        throw __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createError"]('Cannot escape ID with null character (u0000)', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_NULL_CHAR_ESCAPEID, info, '0A000');
    }
...
function escapeParameters(opts, info, value) {
    ...
    switch(typeof value){
        ...
        case 'object':
            if (Object.prototype.toString.call(value) === '[object Date]') {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$encoder$2f$text$2d$encoder$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].getFixedFormatDate(value);
            } else if (Buffer.isBuffer(value)) {
                let stValue;
                if (Buffer.isEncoding(info.collation.charset)) {
                    stValue = value.toString(info.collation.charset, 0, value.length);
                } else {
                    stValue = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$iconv$2d$lite$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].decode(value, info.collation.charset);
                }
                ...
                if (value.type != null && [
                    ...
                    switch(value.type){
                        case 'Point':
                            return prefix + "PointFromText('POINT(" + __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$encoder$2f$text$2d$encoder$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].geoPointToString(value.coordinates) + ")')";
                        case 'LineString':
                            return prefix + "LineFromText('LINESTRING(" + __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$encoder$2f$text$2d$encoder$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].geoArrayPointToString(value.coordinates) + ")')";
                        case 'Polygon':
                            return prefix + "PolygonFromText('POLYGON(" + __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$encoder$2f$text$2d$encoder$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].geoMultiArrayPointToString(value.coordinates) + ")')";
                        case 'MultiPoint':
                            return prefix + "MULTIPOINTFROMTEXT('MULTIPOINT(" + __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$encoder$2f$text$2d$encoder$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].geoArrayPointToString(value.coordinates) + ")')";
                        case 'MultiLineString':
                            return prefix + "MLineFromText('MULTILINESTRING(" + __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$encoder$2f$text$2d$encoder$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].geoMultiArrayPointToString(value.coordinates) + ")')";
                        case 'MultiPolygon':
                            return prefix + "MPolyFromText('MULTIPOLYGON(" + __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$encoder$2f$text$2d$encoder$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].geoMultiPolygonToString(value.coordinates) + ")')";
                        case 'GeometryCollection':
                            return prefix + "GeomCollFromText('GEOMETRYCOLLECTION(" + __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$encoder$2f$text$2d$encoder$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].geometricCollectionToString(value.geometries) + ")')";
                    }
                } else {
                    if (opts.permitSetMultiParamEntries) {
                        let out = '';
...
"[project]/node_modules/mariadb/lib/io/packet-input-stream.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$io$2f$packet$2d$node$2d$encoded$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/io/packet-node-encoded.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$io$2f$packet$2d$node$2d$iconv$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/io/packet-node-iconv.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$collations$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/const/collations.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/misc/utils.js [app-route] (ecmascript)");
//  SPDX-License-Identifier: LGPL-2.1-or-later
//  Copyright (c) 2015-2025 MariaDB Corporation Ab
'use strict';
;
 ...
 */ class PacketInputStream {
    constructor(unexpectedPacket, receiveQueue, out, opts, info){
        ...
        this._cmd = null;
        this.changeEncoding(this.opts.collation ? this.opts.collation : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$collations$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].fromIndex(224));
    ...
    changeEncoding(collation) {
        ...
        this.packet = Buffer.isEncoding(this.encoding) ? new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$io$2f$packet$2d$node$2d$encoded$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](this.encoding) : new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$io$2f$packet$2d$node$2d$iconv$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](this.encoding);
    }
    changeDebug(debug) {
        this._debug = debug;
    ...
    receivePacketDebug(packet) {
        ...
        if (packet) {
            this.opts.logger.network(`<== conn:${this.info.threadId ? this.info.threadId : -1} ${cmd ? cmd.onPacketReceive ? cmd.constructor.name + '.' + cmd.onPacketReceive.name : cmd.constructor.name : 'no command'} (${packet.pos},${packet.end})\n${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["log"])(this.opts, packet.buf, packet.pos, packet.end, this.header)}`);
        }
        if (!cmd) {
...
const __TURBOPACK__default__export__ = PacketInputStream;
}),
"[project]/node_modules/mariadb/lib/io/packet-output-stream.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ class PacketOutputStream {
   ...
   */ writeStringAscii(str) {
    ...
    encodeIconvString(str) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$iconv$2d$lite$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].encode(str, this.encoding);
    }
    ...
    writeDefaultIconvString(str) {
        let buf = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$iconv$2d$lite$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].encode(str, this.encoding);
   ...
   */ checkMaxAllowedLength(length, info) {
        if (this.opts.maxAllowedPacket && this.cmdLength + length >= this.maxAllowedPacket) {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createError"](`query size (${this.cmdLength + length}) is >= to max_allowed_packet (${this.maxAllowedPacket})`, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_MAX_ALLOWED_PACKET, info);
        }
        return null;
    }
    /**
   ...
   */ flushBufferDebug(commandEnd, remainingLen) {
        if (this.pos > 4) {
            ...
            this.opts.logger.network(`==> conn:${this.info.threadId ? this.info.threadId : -1} ${this.cmd.constructor.name + '(0,' + this.pos + ')'}\n${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["log"])(this.opts, this.buf, 0, this.pos)}`);
   ...
   */ flushBufferStopAtMark() {
    ...
    fastFlushDebug(cmd, packet) {
        ...
        this.opts.logger.network(`==> conn:${this.info.threadId ? this.info.threadId : -1} ${cmd.constructor.name + '(0,' + packet.length + ')'}\n${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["log"])(this.opts, packet, 0, packet.length)}`);
        this.cmdLength = 0;
        this.markPos = -1;
    }
    ...
    writeEmptyPacket() {
        ...
        if (this.debug) {
            this.opts.logger.network(`==> conn:${this.info.threadId ? this.info.threadId : -1} ${this.cmd.constructor.name}(0,4)\n${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["log"])(this.opts, emptyBuf, 0, 4)}`);
        }
...
const __TURBOPACK__default__export__ = PacketOutputStream;
}),
"[project]/node_modules/mariadb/lib/io/compression-input-stream.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ class CompressionInputStream {
    ...
    receivePacket(chunk) {
        ...
        if (this.opts.debugCompress) {
            this.opts.logger.network(`<== conn:${this.info.threadId ? this.info.threadId : -1} ${cmd ? cmd.onPacketReceive ? cmd.constructor.name + '.' + cmd.onPacketReceive.name : cmd.constructor.name : 'no command'} (compress)\n${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["log"])(this.opts, chunk, 0, chunk.length, this.header)}`);
        }
        ...
        if (unCompressLen === 0) {
            ...
            const unCompressChunk = __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$zlib__$5b$external$5d$__$28$node$3a$zlib$2c$__cjs$29$__["default"].inflateSync(chunk);
...
const __TURBOPACK__default__export__ = CompressionInputStream;
}),
"[project]/node_modules/mariadb/lib/io/compression-output-stream.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ class CompressionOutputStream {
   ...
   */ flush(cmdEnd, cmd, remainingLen) {
        if (this.pos < 1536) {
            ...
            //*******************************************************************************
            //use synchronous inflating, to ensure FIFO packet order
            const compressChunk = __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$zlib__$5b$external$5d$__$28$node$3a$zlib$2c$__cjs$29$__["default"].deflateSync(this.buf.subarray(7, this.pos));
            ...
            if (this.opts.debugCompress) {
                this.opts.logger.network(`==> conn:${this.info.threadId ? this.info.threadId : -1} ${cmd ? cmd.constructor.name + '(0,' + this.pos + '=>' + compressChunkLen + ')' : 'unknown'} (compress)\n${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["log"])(this.opts, compressChunk, 0, compressChunkLen, this.header)}`);
            }
    ...
    writeEmptyPacket(cmd) {
        ...
        if (this.opts.debugCompress) {
            this.opts.logger.network(`==> conn:${this.info.threadId ? this.info.threadId : -1} ${cmd ? cmd.constructor.name + '(0,' + this.pos + ')' : 'unknown'} (compress)\n${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["log"])(this.opts, emptyBuf, 0, 7)}`);
        }
        this.writer(emptyBuf);
    }
}
const __TURBOPACK__default__export__ = CompressionOutputStream;
}),
"[project]/node_modules/mariadb/lib/const/server-status.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const STATUS_IN_TRANS = 1;
const STATUS_AUTOCOMMIT = 2;
const MORE_RESULTS_EXISTS = 8;
const QUERY_NO_GOOD_INDEX_USED = 16;
const QUERY_NO_INDEX_USED = 32;
const STATUS_CURSOR_EXISTS = 64;
const STATUS_LAST_ROW_SENT = 128;
const STATUS_DB_DROPPED = 1 << 8;
const STATUS_NO_BACKSLASH_ESCAPES = 1 << 9;
const STATUS_METADATA_CHANGED = 1 << 10;
const QUERY_WAS_SLOW = 1 << 11;
const PS_OUT_PARAMS = 1 << 12;
const STATUS_IN_TRANS_READONLY = 1 << 13;
const SESSION_STATE_CHANGED = 1 << 14;
}),
"[project]/node_modules/mariadb/lib/misc/connection-information.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const __TURBOPACK__default__export__ = ConnectionInformation;
}),
"[project]/node_modules/mariadb/lib/const/capabilities.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ /* mysql/old mariadb server/client */ __turbopack_context__.s([
    "BULK_UNIT_RESULTS",
    ()=>BULK_UNIT_RESULTS,
...
const FOUND_ROWS = 2n;
const LONG_FLAG = 4n;
const CONNECT_WITH_DB = 8n;
const NO_SCHEMA = 1n << 4n;
const COMPRESS = 1n << 5n;
const ODBC = 1n << 6n;
const LOCAL_FILES = 1n << 7n;
const IGNORE_SPACE = 1n << 8n;
const PROTOCOL_41 = 1n << 9n;
const INTERACTIVE = 1n << 10n;
const SSL = 1n << 11n;
const IGNORE_SIGPIPE = 1n << 12n;
const TRANSACTIONS = 1n << 13n;
const RESERVED = 1n << 14n;
const SECURE_CONNECTION = 1n << 15n;
const MULTI_STATEMENTS = 1n << 16n;
const MULTI_RESULTS = 1n << 17n;
const PS_MULTI_RESULTS = 1n << 18n;
const PLUGIN_AUTH = 1n << 19n;
const CONNECT_ATTRS = 1n << 20n;
const PLUGIN_AUTH_LENENC_CLIENT_DATA = 1n << 21n;
const CAN_HANDLE_EXPIRED_PASSWORDS = 1n << 22n;
const SESSION_TRACK = 1n << 23n;
const DEPRECATE_EOF = 1n << 24n;
const SSL_VERIFY_SERVER_CERT = 1n << 30n;
const MARIADB_CLIENT_STMT_BULK_OPERATIONS = 1n << 34n;
const MARIADB_CLIENT_EXTENDED_METADATA = 1n << 35n;
const MARIADB_CLIENT_CACHE_METADATA = 1n << 36n;
const BULK_UNIT_RESULTS = 1n << 37n;
}),
"[project]/node_modules/mariadb/lib/config/connection-options.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    constructor(opts){
        ...
        if (opts.charset && typeof opts.charset === 'string') {
            if (opts.collation && typeof opts.collation === 'string') {
                ...
                this.collation = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$collations$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].fromCharsetAndName(opts.charset.toLowerCase(), opts.collation.toUpperCase());
                if (this.collation === undefined) throw new RangeError("Unknown collation '" + opts.collation + "' with charset '" + opts.charset + "'");
            }
            this.collation = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$collations$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].fromCharset(opts.charset.toLowerCase());
            if (this.collation === undefined) {
                this.collation = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$collations$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].fromName(opts.charset.toUpperCase());
                if (this.collation !== undefined) {
            ...
            this.collation = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$collations$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].fromName(opts.collation.toUpperCase());
            if (this.collation === undefined) throw new RangeError("Unknown collation '" + opts.collation + "'");
        } else {
            this.collation = opts.charsetNumber ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$collations$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].fromIndex(Number(opts.charsetNumber)) : undefined;
        }
        // connection options
...
const __TURBOPACK__default__export__ = ConnectionOptions;
}),
"[project]/node_modules/mariadb/lib/cmd/command.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ class Command extends __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$events__$5b$external$5d$__$28$node$3a$events$2c$__cjs$29$__["default"] {
   ...
   */ throwUnexpectedError(msg, fatal, info, sqlState, errno) {
        const err = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createError"](msg, errno, info, sqlState, this.opts && this.opts.logParam ? this.displaySql() : this.sql, fatal, this.cmdParam ? this.cmdParam.stack : null, false);
        if (this.reject) {
   ...
   */ sendCancelled(msg, errno, info) {
        const err = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createError"](msg, errno, info, 'HY000', this.opts.logParam ? this.displaySql() : this.sql);
        this.emit('send_end');
   ...
   */ throwError(err, info) {
        ...
        if (this.reject) {
            if (this.cmdParam && this.cmdParam.stack) {
                err = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createError"](err.text ? err.text : err.message, err.errno, info, err.sqlState, err.sql, err.fatal, this.cmdParam.stack, false);
            }
            this.resolve = null;
            process.nextTick(this.reject, err);
            this.reject = null;
...
"[project]/node_modules/mariadb/lib/cmd/handshake/auth/plugin-auth.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$command$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/cmd/command.js [app-route] (ecmascript)");
//  SPDX-License-Identifier: LGPL-2.1-or-later
//  Copyright (c) 2015-2024 MariaDB Corporation Ab
'use strict';
;
 ...
 */ class PluginAuth extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$command$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"] {
...
const __TURBOPACK__default__export__ = PluginAuth;
}),
"[project]/node_modules/mariadb/lib/cmd/handshake/auth/initial-handshake.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$capabilities$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/const/capabilities.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$collations$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/const/collations.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$connection$2d$information$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/misc/connection-information.js [app-route] (ecmascript)");
//  SPDX-License-Identifier: LGPL-2.1-or-later
//  Copyright (c) 2015-2024 MariaDB Corporation Ab
'use strict';
;
 ...
 */ class InitialHandshake {
    constructor(packet, info){
        ...
        info.collation = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$collations$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].fromIndex(packet.readUInt8());
        info.status = packet.readUInt16();
        serverCapabilities += BigInt(packet.readUInt16()) << 16n;
        let saltLength = 0;
        if (serverCapabilities & __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$capabilities$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PLUGIN_AUTH"]) {
            saltLength = Math.max(12, packet.readUInt8() - 9);
        } else {
            packet.skip(1);
        }
        if (serverCapabilities & __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$capabilities$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MYSQL"]) {
            packet.skip(10);
        } else {
            packet.skip(6);
            serverCapabilities += BigInt(packet.readUInt32()) << 32n;
        }
        if (serverCapabilities & __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$capabilities$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SECURE_CONNECTION"]) {
     ...
     **/ if (info.serverVersion.raw.startsWith('5.5.5-')) {
            ...
            info.serverVersion.mariaDb = info.serverVersion.raw.includes('MariaDB') || (serverCapabilities & __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$capabilities$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MYSQL"]) === 0n;
        }
        if (serverCapabilities & __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$capabilities$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PLUGIN_AUTH"]) {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$connection$2d$information$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].parseVersionString(info);
    }
}
const __TURBOPACK__default__export__ = InitialHandshake;
}),
"[project]/node_modules/mariadb/lib/cmd/handshake/client-capabilities.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
'use strict';
;
function init(opts, info) {
    let capabilities = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$capabilities$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["IGNORE_SPACE"] | __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$capabilities$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PROTOCOL_41"] | __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$capabilities$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TRANSACTIONS"] | __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$capabilities$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SECURE_CONNECTION"] | __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$capabilities$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MULTI_RESULTS"] | __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$capabilities$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PS_MULTI_RESULTS"] | __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$capabilities$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SESSION_TRACK"] | __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$capabilities$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["CONNECT_ATTRS"] | __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$capabilities$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PLUGIN_AUTH_LENENC_CLIENT_DATA"] | __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$capabilities$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MARIADB_CLIENT_EXTENDED_METADATA"] | __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$capabilities$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PLUGIN_AUTH"];
    if (opts.foundRows) {
        capabilities |= __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$capabilities$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["FOUND_ROWS"];
    }
    if (opts.permitLocalInfile) {
        capabilities |= __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$capabilities$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["LOCAL_FILES"];
    }
    if (opts.multipleStatements) {
        capabilities |= __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$capabilities$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MULTI_STATEMENTS"];
    }
    info.eofDeprecated = !opts.keepEof && (info.serverCapabilities & __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$capabilities$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DEPRECATE_EOF"]) > 0;
    if (info.eofDeprecated) {
        capabilities |= __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$capabilities$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DEPRECATE_EOF"];
    }
    if (opts.database && info.serverCapabilities & __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$capabilities$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["CONNECT_WITH_DB"]) {
        capabilities |= __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$capabilities$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["CONNECT_WITH_DB"];
    }
    info.serverPermitSkipMeta = (info.serverCapabilities & __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$capabilities$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MARIADB_CLIENT_CACHE_METADATA"]) > 0;
    if (info.serverPermitSkipMeta) {
        capabilities |= __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$capabilities$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MARIADB_CLIENT_CACHE_METADATA"];
    }
    // use compression only if requested by client and supported by server
    if (opts.compress) {
        if (info.serverCapabilities & __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$capabilities$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["COMPRESS"]) {
            capabilities |= __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$capabilities$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["COMPRESS"];
        } else {
            opts.compress = false;
        }
    }
    if (opts.bulk && info.serverCapabilities & __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$capabilities$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MARIADB_CLIENT_STMT_BULK_OPERATIONS"]) {
        capabilities |= __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$capabilities$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MARIADB_CLIENT_STMT_BULK_OPERATIONS"];
        capabilities |= __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$capabilities$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BULK_UNIT_RESULTS"];
    }
    if (opts.permitConnectionWhenExpired) {
        capabilities |= __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$capabilities$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["CAN_HANDLE_EXPIRED_PASSWORDS"];
    }
    info.clientCapabilities = capabilities & info.serverCapabilities;
}
}),
"[project]/node_modules/mariadb/lib/cmd/handshake/ssl-request.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$capabilities$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/const/capabilities.js [app-route] (ecmascript)");
;
function send(cmd, out, info, opts) {
    out.startPacket(cmd);
    ...
    if (info.serverCapabilities & __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$capabilities$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MYSQL"]) {
        out.writeInt32(0);
    } else {
...
"[project]/node_modules/mariadb/lib/cmd/handshake/auth/native-password-auth.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$handshake$2f$auth$2f$plugin$2d$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/cmd/handshake/auth/plugin-auth.js [app-route] (ecmascript)");
 ...
 */ class NativePasswordAuth extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$handshake$2f$auth$2f$plugin$2d$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"] {
    ...
    static encryptSha1Password(password, seed) {
        ...
        let hash = __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$crypto__$5b$external$5d$__$28$node$3a$crypto$2c$__cjs$29$__["default"].createHash('sha1');
        let stage1 = hash.update(password, 'utf8').digest();
        hash = __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$crypto__$5b$external$5d$__$28$node$3a$crypto$2c$__cjs$29$__["default"].createHash('sha1');
...
const __TURBOPACK__default__export__ = NativePasswordAuth;
}),
"[project]/node_modules/mariadb/lib/cmd/handshake/auth/handshake.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
//  Copyright (c) 2015-2024 MariaDB Corporation Ab
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$handshake$2f$auth$2f$plugin$2d$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/cmd/handshake/auth/plugin-auth.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$handshake$2f$auth$2f$initial$2d$handshake$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/cmd/handshake/auth/initial-handshake.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$handshake$2f$client$2d$capabilities$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/cmd/handshake/client-capabilities.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$capabilities$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/const/capabilities.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$handshake$2f$ssl$2d$request$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/cmd/handshake/ssl-request.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/misc/errors.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$handshake$2f$auth$2f$native$2d$password$2d$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/cmd/handshake/auth/native-password-auth.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$iconv$2d$lite$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/iconv-lite/lib/index.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$crypto__$5b$external$5d$__$28$node$3a$crypto$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/node:crypto [external] (node:crypto, cjs)");
...
;
;
const driverVersion = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$package$2e$json$2e5b$json$5d2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].version;
/**
 * Handshake response
 */ class Handshake extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$handshake$2f$auth$2f$plugin$2d$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"] {
    ...
    parseHandshakeInit(packet, out, opts, info) {
        ...
        let handshake = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$handshake$2f$auth$2f$initial$2d$handshake$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](packet, info);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$handshake$2f$client$2d$capabilities$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(opts, info);
        this.pluginName = handshake.pluginName;
        if (opts.ssl) {
            if (info.serverCapabilities & __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$capabilities$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SSL"]) {
                info.clientCapabilities |= __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$capabilities$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SSL"];
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$handshake$2f$ssl$2d$request$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(this, out, info, opts);
                ...
                return this.throwNewError('Trying to connect with ssl, but ssl not enabled in the server', true, info, '08S01', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_SERVER_SSL_DISABLED);
            }
        } else {
   ...
   */ static send(cmd, out, opts, pluginName, info) {
        ...
        switch(pluginName){
            case 'mysql_clear_password':
                ...
                break;
            default:
                authToken = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$handshake$2f$auth$2f$native$2d$password$2d$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].encryptSha1Password(pwd, info.seed);
        ...
        out.writeInt8(0);
        if (info.serverCapabilities & __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$capabilities$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PLUGIN_AUTH_LENENC_CLIENT_DATA"]) {
            out.writeLengthCoded(authToken.length);
            out.writeBuffer(authToken, 0, authToken.length);
        } else if (info.serverCapabilities & __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$capabilities$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SECURE_CONNECTION"]) {
        ...
        if (info.clientCapabilities & __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$capabilities$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["CONNECT_WITH_DB"]) {
            out.writeString(opts.database);
            out.writeInt8(0);
            info.database = opts.database;
        }
        if (info.clientCapabilities & __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$capabilities$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PLUGIN_AUTH"]) {
            out.writeString(authPlugin);
            out.writeInt8(0);
        }
        if (info.clientCapabilities & __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$capabilities$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["CONNECT_ATTRS"]) {
            out.writeInt8(0xfc);
            ...
            Handshake.writeAttribute(out, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$os__$5b$external$5d$__$28$node$3a$os$2c$__cjs$29$__["default"].hostname(), encoding);
    ...
    static writeAttribute(out, val, encoding) {
        let param = Buffer.isEncoding(encoding) ? Buffer.from(val, encoding) : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$iconv$2d$lite$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["encode"](val, encoding);
...
"[project]/node_modules/mariadb/lib/const/state-change.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const SESSION_TRACK_SYSTEM_VARIABLES = 0;
const SESSION_TRACK_SCHEMA = 1;
const SESSION_TRACK_STATE_CHANGE = 2;
const SESSION_TRACK_GTIDS = 3;
const SESSION_TRACK_TRANSACTION_CHARACTERISTICS = 4;
const SESSION_TRACK_TRANSACTION_STATE = 5;
}),
"[project]/node_modules/mariadb/lib/cmd/handshake/auth/clear-password-auth.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ class ClearPasswordAuth extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$handshake$2f$auth$2f$plugin$2d$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"] {
    constructor(packSeq, compressPackSeq, pluginData, cmdParam, reject, multiAuthResolver){
        super(cmdParam, multiAuthResolver, reject);
        this.sequenceNo = packSeq;
        this.compressSequenceNo = compressPackSeq;
...
const __TURBOPACK__default__export__ = ClearPasswordAuth;
}),
"[project]/node_modules/mariadb/lib/cmd/handshake/auth/ed25519-password-auth.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
/**
 * Standard authentication plugin
 */ class Ed25519PasswordAuth extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$handshake$2f$auth$2f$plugin$2d$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"] {
    constructor(packSeq, compressPackSeq, pluginData, cmdParam, reject, multiAuthResolver){
        super(cmdParam, multiAuthResolver, reject);
        this.pluginData = pluginData;
        this.sequenceNo = packSeq;
    ...
    static encryptPassword(password, seed1) {
        ...
        let hash = __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$crypto__$5b$external$5d$__$28$node$3a$crypto$2c$__cjs$29$__["default"].createHash('sha512');
        ...
        hash = __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$crypto__$5b$external$5d$__$28$node$3a$crypto$2c$__cjs$29$__["default"].createHash('sha512');
...
const __TURBOPACK__default__export__ = Ed25519PasswordAuth;
}),
"[project]/node_modules/mariadb/lib/cmd/handshake/auth/parsec-auth.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
/**
 * Standard authentication plugin
 */ class ParsecAuth extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$handshake$2f$auth$2f$plugin$2d$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"] {
    #hash;
    constructor(packSeq, compressPackSeq, pluginData, cmdParam, reject, multiAuthResolver){
        super(cmdParam, multiAuthResolver, reject);
        this.multiAuthResolver = multiAuthResolver;
    ...
    parseExtSalt(extSalt, info) {
        ...
        if (extSalt.length < 2 || extSalt[pos] !== 0x50 || extSalt[pos + 1] > 20) {
            ...
            return this.throwError(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createFatalError"]('Wrong parsec authentication format', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_AUTHENTICATION_BAD_PACKET, info), info);
        }
    ...
    sendScramble(out, opts, info) {
        const derivedKey = __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$crypto__$5b$external$5d$__$28$node$3a$crypto$2c$__cjs$29$__["default"].pbkdf2Sync(opts.password || '', this.salt, 1024 << this.iterations, 32, 'sha512');
        ...
        const client_scramble = __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$crypto__$5b$external$5d$__$28$node$3a$crypto$2c$__cjs$29$__["default"].randomBytes(32);
        const message = Buffer.concat([
            this.pluginData,
            client_scramble
        ]);
        const signature = __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$crypto__$5b$external$5d$__$28$node$3a$crypto$2c$__cjs$29$__["default"].sign(null, message, privateKey);
        out.startPacket(this);
    ...
    getEd25519PublicKeyFromPrivateKey(privateKeyBuffer) {
        ...
        const privateKey = __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$crypto__$5b$external$5d$__$28$node$3a$crypto$2c$__cjs$29$__["default"].createPrivateKey({
            key: Buffer.concat([
                pkcs8Ed25519header,
                privateKeyBuffer
            ]),
        ...
        const publicKey = __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$crypto__$5b$external$5d$__$28$node$3a$crypto$2c$__cjs$29$__["default"].createPublicKey(privateKey);
...
const toPkcs8der = (rawB64)=>{
    ...
    return __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$crypto__$5b$external$5d$__$28$node$3a$crypto$2c$__cjs$29$__["default"].createPrivateKey({
        key: der,
        format: 'der',
        type: 'pkcs8'
    });
};
const __TURBOPACK__default__export__ = ParsecAuth;
}),
"[project]/node_modules/mariadb/lib/cmd/handshake/auth/pam-password-auth.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ class PamPasswordAuth extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$handshake$2f$auth$2f$plugin$2d$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"] {
    constructor(packSeq, compressPackSeq, pluginData, cmdParam, reject, multiAuthResolver){
        super(cmdParam, multiAuthResolver, reject);
        this.pluginData = pluginData;
        this.sequenceNo = packSeq;
...
const __TURBOPACK__default__export__ = PamPasswordAuth;
}),
"[project]/node_modules/mariadb/lib/cmd/handshake/auth/sha256-password-auth.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ class Sha256PasswordAuth extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$handshake$2f$auth$2f$plugin$2d$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"] {
    constructor(packSeq, compressPackSeq, pluginData, cmdParam, reject, multiAuthResolver){
        super(cmdParam, multiAuthResolver, reject);
        this.pluginData = pluginData;
        this.sequenceNo = packSeq;
                ...
                if (opts.rsaPublicKey) {
                    try {
                        ...
                        if (!key.includes('-----BEGIN')) {
                            ...
                            key = __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$fs__$5b$external$5d$__$28$node$3a$fs$2c$__cjs$29$__["default"].readFileSync(key, 'utf8');
                        }
                    ...
                    if (!opts.allowPublicKeyRetrieval) {
                        return this.throwError(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createFatalError"]('RSA public key is not available client side. Either set option `rsaPublicKey` to indicate' + ' public key path, or allow public key retrieval with option `allowPublicKeyRetrieval`', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_CANNOT_RETRIEVE_RSA_KEY, info), info);
                    }
    ...
    static encryptSha256Password(password, seed) {
        if (!password) return Buffer.alloc(0);
        let hash = __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$crypto__$5b$external$5d$__$28$node$3a$crypto$2c$__cjs$29$__["default"].createHash('sha256');
        let stage1 = hash.update(password, 'utf8').digest();
        hash = __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$crypto__$5b$external$5d$__$28$node$3a$crypto$2c$__cjs$29$__["default"].createHash('sha256');
        let stage2 = hash.update(stage1).digest();
        hash = __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$crypto__$5b$external$5d$__$28$node$3a$crypto$2c$__cjs$29$__["default"].createHash('sha256');
    ...
    static encrypt(seed, password, publicKey) {
        ...
        return __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$crypto__$5b$external$5d$__$28$node$3a$crypto$2c$__cjs$29$__["default"].publicEncrypt({
            key: publicKey,
            padding: __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$crypto__$5b$external$5d$__$28$node$3a$crypto$2c$__cjs$29$__["default"].constants.RSA_PKCS1_OAEP_PADDING
        }, xorBytes);
    }
    response(packet, out, opts, info) {
        const marker = packet.peek();
...
const __TURBOPACK__default__export__ = Sha256PasswordAuth;
}),
"[project]/node_modules/mariadb/lib/cmd/handshake/auth/caching-sha2-password-auth.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$fs__$5b$external$5d$__$28$node$3a$fs$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/node:fs [external] (node:fs, cjs)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/misc/errors.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$handshake$2f$auth$2f$sha256$2d$password$2d$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/cmd/handshake/auth/sha256-password-auth.js [app-route] (ecmascript)");
;
;
;
;
 ...
 */ class CachingSha2PasswordAuth extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$handshake$2f$auth$2f$plugin$2d$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"] {
    constructor(packSeq, compressPackSeq, pluginData, cmdParam, reject, multiAuthResolver){
        super(cmdParam, multiAuthResolver, reject);
        this.multiAuthResolver = multiAuthResolver;
        this.pluginData = pluginData;
    ...
    exchange(packet, out, opts, info) {
        switch(this.state){
            case State.INIT:
                ...
                const encPwd = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$handshake$2f$auth$2f$sha256$2d$password$2d$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].encryptSha256Password(opts.password, truncatedSeed);
                out.startPacket(this);
                if (encPwd.length > 0) {
                    ...
                    case 0x04:
                        if (this.isSecureConnection()) {
                            if (info.requireValidCert && info.selfSignedCertificate) {
                                return this.throwError(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createFatalError"]('cannot send a `caching_sha2_password` and SSL without providing server certificates,' + ' cannot send password in clear on an untrusted SSL connection', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_SELF_SIGNED_SHA256, info), info);
                            }
                        ...
                        if (opts.cachingRsaPublicKey) {
                            try {
                                ...
                                this.publicKey = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$handshake$2f$auth$2f$sha256$2d$password$2d$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].retrievePublicKey(key);
                            } catch (err) {
                                return this.throwError(err, info);
                            }
                            // send Sha256Password Packet
                            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$handshake$2f$auth$2f$sha256$2d$password$2d$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].sendSha256PwdPacket(this, this.pluginData, this.publicKey, opts.password, out);
                        } else {
                            if (!opts.allowPublicKeyRetrieval) {
                                return this.throwError(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createFatalError"]('RSA public key is not available client side. Either set option `cachingRsaPublicKey` to indicate' + ' public key path, or allow public key retrieval with option `allowPublicKeyRetrieval`', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_CANNOT_RETRIEVE_RSA_KEY, info), info);
                            }
            ...
            case State.REQUEST_SERVER_KEY:
                this.publicKey = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$handshake$2f$auth$2f$sha256$2d$password$2d$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].retrievePublicKey(packet.toString(undefined, 1));
...
const __TURBOPACK__default__export__ = CachingSha2PasswordAuth;
}),
"[project]/node_modules/mariadb/lib/cmd/handshake/authentication.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/misc/errors.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$capabilities$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/const/capabilities.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$handshake$2f$auth$2f$handshake$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/cmd/handshake/auth/handshake.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$server$2d$status$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/const/server-status.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$state$2d$change$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/const/state-change.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$collations$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/const/collations.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$crypto__$5b$external$5d$__$28$node$3a$crypto$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/node:crypto [external] (node:crypto, cjs)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/misc/utils.js [app-route] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$handshake$2f$auth$2f$native$2d$password$2d$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/cmd/handshake/auth/native-password-auth.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$handshake$2f$auth$2f$clear$2d$password$2d$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/cmd/handshake/auth/clear-password-auth.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$handshake$2f$auth$2f$ed25519$2d$password$2d$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/cmd/handshake/auth/ed25519-password-auth.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$handshake$2f$auth$2f$parsec$2d$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/cmd/handshake/auth/parsec-auth.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$handshake$2f$auth$2f$pam$2d$password$2d$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/cmd/handshake/auth/pam-password-auth.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$handshake$2f$auth$2f$sha256$2d$password$2d$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/cmd/handshake/auth/sha256-password-auth.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$handshake$2f$auth$2f$caching$2d$sha2$2d$password$2d$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/cmd/handshake/auth/caching-sha2-password-auth.js [app-route] (ecmascript)");
//  SPDX-License-Identifier: LGPL-2.1-or-later
//  Copyright (c) 2015-2025 MariaDB Corporation Ab
'use strict';
;
...
const authenticationPlugins = {
    mysql_native_password: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$handshake$2f$auth$2f$native$2d$password$2d$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"],
    mysql_clear_password: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$handshake$2f$auth$2f$clear$2d$password$2d$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"],
    client_ed25519: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$handshake$2f$auth$2f$ed25519$2d$password$2d$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"],
    parsec: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$handshake$2f$auth$2f$parsec$2d$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"],
    dialog: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$handshake$2f$auth$2f$pam$2d$password$2d$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"],
    sha256_password: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$handshake$2f$auth$2f$sha256$2d$password$2d$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"],
    caching_sha2_password: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$handshake$2f$auth$2f$caching$2d$sha2$2d$password$2d$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"]
};
/**
 * Handle handshake.
 * see https://mariadb.com/kb/en/library/1-connecting-connecting/
 */ class Authentication extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$command$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"] {
    constructor(cmdParam, host, resolve, reject, _createSecureContext, getSocket){
        ...
        this.getSocket = getSocket;
        this.plugin = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$handshake$2f$auth$2f$handshake$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](this, host, getSocket, this.handshakeResult, reject);
    }
   ...
   */ handshakeResult(packet, out, opts, info) {
        ...
        switch(marker){
            ...
            case 0x00:
                ...
                if (info.requireValidCert) {
                    if (info.selfSignedCertificate) {
                        ...
                        if (packet.remaining()) {
                            ...
                            if (validationHash.length > 0) {
                                if (!this.plugin.permitHash() || !Boolean(this.cmdParam.opts.password)) {
                                    return this.throwNewError('Self signed certificates. Either set `ssl: { rejectUnauthorized: false }` ' + '(trust mode) or provide server certificate to client', true, info, '08000', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_SELF_SIGNED_NO_PWD);
                                }
                        ...
                        return this.throwNewError('self-signed certificate', true, info, '08000', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_SELF_SIGNED);
                    } else {
                        // certificate is not self signed, validate server identity
                        const validationFunction = opts.ssl === true || typeof opts.ssl.checkServerIdentity !== 'function' ? __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$tls__$5b$external$5d$__$28$node$3a$tls$2c$__cjs$29$__["default"].checkServerIdentity : opts.ssl.checkServerIdentity;
                        ...
                        if (identityError) {
                            return this.throwNewError('certificate identify Error: ' + identityError.message, true, info, '08000', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_TLS_IDENTITY_ERROR);
                        }
                    }
                }
                let mustRedirect = false;
                if (info.status & __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$server$2d$status$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SESSION_STATE_CHANGED"]) {
                    packet.skip(2); //skip warning count
                    ...
                    while(packet.remaining()){
                        ...
                        if (len > 0) {
                            ...
                            while(subPacket.remaining()){
                                ...
                                switch(type){
                                    case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$state$2d$change$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SESSION_TRACK_SYSTEM_VARIABLES"]:
                                        let subSubPacket;
                                        do {
                                            ...
                                            switch(variable){
                                                case 'character_set_client':
                                                    info.collation = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$collations$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].fromCharset(value);
                                        ...
                                        break;
                                    case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$state$2d$change$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SESSION_TRACK_SCHEMA"]:
            ...
            case 0xff:
                ...
                if (info.requireValidCert && info.selfSignedCertificate) {
                    // TLS was forced to trust, and certificate validation is required
                    return this.plugin.throwNewError('Self signed certificates. Either set `ssl: { rejectUnauthorized: false }` ' + '(trust mode) or provide server certificate to client', true, info, '08000', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_SELF_SIGNED_NO_PWD);
                }
            ...
            //*********************************************************************************************************
            default:
                this.throwNewError(`Unexpected type of packet during handshake phase : ${marker}`, true, info, '42000', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_AUTHENTICATION_BAD_PACKET);
        }
    }
    validateFingerPrint(validationHash, info) {
        ...
        if (validationHash[0] !== 0x01) {
            const err = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createFatalError"](`Unexpected hash format for fingerprint hash encoding`, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_UNEXPECTED_PACKET, this.info);
        ...
        const hashHex = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["toHexString"])(digest);
   ...
   */ dispatchAuthSwitchRequest(packet, out, opts, info) {
        ...
        if (info.requireValidCert && info.selfSignedCertificate && Boolean(this.cmdParam.opts.password) && !this.plugin.permitHash()) {
            return this.throwNewError(`Unsupported authentication plugin ${pluginName} with Self signed certificates. 
        Either set 'ssl: { rejectUnauthorized: false }' (trust mode) or provide server certificate to client`, true, info, '08000', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_SELF_SIGNED_BAD_PLUGIN);
        }
        if (opts.restrictedAuth && !opts.restrictedAuth.includes(pluginName)) {
            this.throwNewError(`Unsupported authentication plugin ${pluginName}. Authorized plugin: ${opts.restrictedAuth.toString()}`, true, info, '42000', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_NOT_SUPPORTED_AUTH_PLUGIN);
            return;
        }
        try {
    ...
    static pluginHandler(pluginName, packSeq, compressPackSeq, pluginData, info, opts, out, cmdParam, authReject, multiAuthResolver) {
        ...
        if (!pluginAuth) {
            throw __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createFatalError"](`Client does not support authentication protocol '${pluginName}' requested by server.`, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_AUTHENTICATION_PLUGIN_NOT_SUPPORTED, info, '08004');
        }
...
"[project]/node_modules/mariadb/lib/cmd/quit.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ class Quit extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$command$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"] {
    constructor(cmdParam, resolve, reject){
        super(cmdParam, resolve, reject);
    }
    start(out, opts, info) {
...
const __TURBOPACK__default__export__ = Quit;
}),
"[project]/node_modules/mariadb/lib/cmd/ping.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ class Ping extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$command$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"] {
    constructor(cmdParam, resolve, reject){
        super(cmdParam, resolve, reject);
    }
    start(out, opts, info) {
   ...
   */ readPingResponsePacket(packet, out, opts, info) {
        ...
        info.status = packet.readUInt16();
        if (info.redirectRequest && (info.status & __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$server$2d$status$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["STATUS_IN_TRANS"]) === 0) {
...
"[project]/node_modules/mariadb/lib/cmd/reset.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ class Reset extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$command$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"] {
    constructor(cmdParam, resolve, reject){
        super(cmdParam, resolve, reject);
    }
    start(out, opts, info) {
...
const __TURBOPACK__default__export__ = Reset;
}),
"[project]/node_modules/mariadb/lib/const/field-type.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/mariadb/lib/const/field-detail.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/mariadb/lib/cmd/column-definition.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$collations$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/const/collations.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/const/field-type.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$detail$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/const/field-detail.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$capabilities$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/const/capabilities.js [app-route] (ecmascript)");
//  SPDX-License-Identifier: LGPL-2.1-or-later
//  Copyright (c) 2015-2024 MariaDB Corporation Ab
'use strict';
...
const GEO_DEFAULT_POINT = {
    type: 'Point'
};
const GEO_DEFAULT_LINESTRING = {
    type: 'LineString'
};
const GEO_DEFAULT_POLYGON = {
    type: 'Polygon'
};
const GEO_DEFAULT_MULTIPOINT = {
    type: 'MultiPoint'
};
const GEO_DEFAULT_MULTILINESTRING = {
    type: 'MultiLineString'
};
const GEO_DEFAULT_MULTIPOLYGON = {
    type: 'MultiPolygon'
};
// noinspection JSBitwiseOperatorUsage
/**
 ...
 */ class ColumnDef {
    ...
    constructor(packet, info, skipName){
        ...
        if (info.clientCapabilities & __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$capabilities$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MARIADB_CLIENT_EXTENDED_METADATA"]) {
            const len = packet.readUnsignedLength();
            if (len > 0) {
                const subPacket = packet.subPacketLengthEncoded(len);
                while(subPacket.remaining()){
        ...
        this.collation = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$collations$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].fromIndex(packet.readUInt16());
        ...
        this.type = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TYPES"][this.columnType];
    }
    __getDefaultGeomVal() {
    ...
    signed() {
        return (this.flags & __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$detail$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["UNSIGNED"]) === 0;
    }
    isSet() {
        return (this.flags & __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$detail$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SET"]) !== 0;
    }
}
/**
 * String parser.
...
const __TURBOPACK__default__export__ = ColumnDef;
}),
"[project]/node_modules/mariadb/lib/misc/parse.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function splitQueryPlaceholder(query, info, initialValues, displaySql) {
        ...
        switch(car){
            ...
            case COLON_BYTE:
                if (state === State.Normal) {
                    ...
                    if (val === undefined) {
                        throw __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createError"](`Placeholder '${placeholderName}' is not defined`, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_PLACEHOLDER_UNDEFINED, info, 'HY000', displaySql.call());
                    }
                    values.push(val);
                }
                break;
...
function searchPlaceholder(sql) {
    let sqlPlaceHolder = '';
...
function validateFileName(sql, parameters, fileName) {
...
function parseQueries(bufState) {
    let state = State.Normal;
    let lastChar = 0x00;
    let currByte;
    let queries = [];
...
"[project]/node_modules/mariadb/lib/cmd/decoder/binary-decoder.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
function newRow(packet, columns) {
...
function castWrapper(column, packet, opts, nullBitmap, index) {
...
function parser(col, opts) {
    ...
    switch(col.columnType){
        case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BIGINT"]:
            if (col.signed()) {
        ...
        case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DATETIME"]:
        case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TIMESTAMP"]:
            return opts.dateStrings ? readTimestampStringBinary.bind(null, col.scale) : readTimestampBinary;
        case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DECIMAL"]:
        case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NEWDECIMAL"]:
            return col.scale === 0 ? readDecimalAsIntBinary : readDecimalBinary;
        case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["GEOMETRY"]:
            let defaultVal = col.__getDefaultGeomVal();
            return readGeometryBinary.bind(null, defaultVal);
        case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BIT"]:
            if (col.columnLength === 1 && opts.bitOneIsBoolean) {
                return readBitBinaryBoolean;
            }
            return readBinaryBuffer;
        case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["JSON"]:
...
const readBigintAsIntBinaryUnsigned = function(packet, opts, throwUnexpectedError, nullBitmap, index) {
    ...
    if (opts.bigIntAsNumber && opts.checkNumberRange && !Number.isSafeInteger(Number(val))) {
        return throwUnexpectedError(`value ${val} can't safely be converted to number`, false, null, '42000', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_PARSING_PRECISION);
    }
...
const readDecimalAsIntBinary = (packet, opts, throwUnexpectedError, nullBitmap, index)=>{
    ...
    if (valDec != null && (opts.decimalAsNumber || opts.supportBigNumbers)) {
        if (opts.decimalAsNumber && opts.checkNumberRange && !Number.isSafeInteger(Number(valDec))) {
            return throwUnexpectedError(`value ${valDec} can't safely be converted to number`, false, null, '42000', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_PARSING_PRECISION);
        }
...
DEFAULT_SIGNED_PARSER_TYPE[__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TINY"]] = readTinyBinarySigned;
DEFAULT_SIGNED_PARSER_TYPE[__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["YEAR"]] = readShortBinarySigned;
DEFAULT_SIGNED_PARSER_TYPE[__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SHORT"]] = readShortBinarySigned;
DEFAULT_SIGNED_PARSER_TYPE[__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["INT24"]] = readMediumBinarySigned;
DEFAULT_SIGNED_PARSER_TYPE[__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["INT"]] = readIntBinarySigned;
DEFAULT_SIGNED_PARSER_TYPE[__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["FLOAT"]] = readFloatBinary;
DEFAULT_SIGNED_PARSER_TYPE[__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DOUBLE"]] = readDoubleBinary;
DEFAULT_SIGNED_PARSER_TYPE[__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DATE"]] = readDateBinary;
DEFAULT_SIGNED_PARSER_TYPE[__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TIME"]] = readTimeBinary;
const DEFAULT_UNSIGNED_PARSER_TYPE = Array(256);
DEFAULT_UNSIGNED_PARSER_TYPE[__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TINY"]] = readTinyBinaryUnsigned;
DEFAULT_UNSIGNED_PARSER_TYPE[__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["YEAR"]] = readShortBinaryUnsigned;
DEFAULT_UNSIGNED_PARSER_TYPE[__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SHORT"]] = readShortBinaryUnsigned;
DEFAULT_UNSIGNED_PARSER_TYPE[__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["INT24"]] = readMediumBinaryUnsigned;
DEFAULT_UNSIGNED_PARSER_TYPE[__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["INT"]] = readIntBinaryUnsigned;
DEFAULT_UNSIGNED_PARSER_TYPE[__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["FLOAT"]] = readFloatBinary;
DEFAULT_UNSIGNED_PARSER_TYPE[__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DOUBLE"]] = readDoubleBinary;
DEFAULT_UNSIGNED_PARSER_TYPE[__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DATE"]] = readDateBinary;
DEFAULT_UNSIGNED_PARSER_TYPE[__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TIME"]] = readTimeBinary;
}),
"[project]/node_modules/mariadb/lib/cmd/decoder/text-decoder.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
DEFAULT_PARSER_TYPE[__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TINY"]] = readIntLengthEncoded;
DEFAULT_PARSER_TYPE[__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SHORT"]] = readIntLengthEncoded;
DEFAULT_PARSER_TYPE[__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["INT"]] = readIntLengthEncoded;
DEFAULT_PARSER_TYPE[__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["INT24"]] = readIntLengthEncoded;
DEFAULT_PARSER_TYPE[__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["YEAR"]] = readIntLengthEncoded;
DEFAULT_PARSER_TYPE[__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["FLOAT"]] = readFloatLengthCoded;
DEFAULT_PARSER_TYPE[__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DOUBLE"]] = readFloatLengthCoded;
DEFAULT_PARSER_TYPE[__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DATE"]] = readDate;
DEFAULT_PARSER_TYPE[__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DATETIME"]] = readTimestamp;
DEFAULT_PARSER_TYPE[__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TIMESTAMP"]] = readTimestamp;
DEFAULT_PARSER_TYPE[__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TIME"]] = readAsciiStringLengthEncoded;
...
"[project]/node_modules/mariadb/lib/cmd/class/ok-packet.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const __TURBOPACK__default__export__ = OkPacket;
}),
"[project]/node_modules/mariadb/lib/cmd/parser.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$command$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/cmd/command.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$server$2d$status$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/const/server-status.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$column$2d$definition$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/cmd/column-definition.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/misc/errors.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$fs__$5b$external$5d$__$28$node$3a$fs$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/node:fs [external] (node:fs, cjs)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$parse$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/misc/parse.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$decoder$2f$binary$2d$decoder$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/cmd/decoder/binary-decoder.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$decoder$2f$text$2d$decoder$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/cmd/decoder/text-decoder.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$class$2f$ok$2d$packet$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/cmd/class/ok-packet.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$state$2d$change$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/const/state-change.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$collations$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/const/collations.js [app-route] (ecmascript)");
//  SPDX-License-Identifier: LGPL-2.1-or-later
//  Copyright (c) 2015-2025 MariaDB Corporation Ab
 ...
 */ class Parser extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$command$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"] {
    /**
   ...
   */ handleErrorPacket(packet, info) {
        ...
        info.status |= __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$server$2d$status$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["STATUS_IN_TRANS"];
        return this.throwError(err, info);
    }
    /**
   ...
   */ readOKPacket(packet, out, opts, info) {
        ...
        info.status = packet.readUInt16();
        const okPacket = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$class$2f$ok$2d$packet$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](affectedRows, insertId, packet.readUInt16());
        let mustRedirect = false;
        ...
        if (info.redirectRequest && (info.status & __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$server$2d$status$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["STATUS_IN_TRANS"]) === 0 && (info.status & __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$server$2d$status$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MORE_RESULTS_EXISTS"]) === 0) {
   ...
   */ processInsertId(insertId, info) {
        if (this.opts.supportBigNumbers || this.opts.insertIdAsNumber) {
            if (this.opts.insertIdAsNumber && this.opts.checkNumberRange && !Number.isSafeInteger(Number(insertId))) {
                this.onPacketReceive = info.status & __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$server$2d$status$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MORE_RESULTS_EXISTS"] ? this.readResponsePacket : null;
                this.throwUnexpectedError(`last insert id value ${insertId} can't safely be converted to number`, false, info, '42000', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_PARSING_PRECISION);
                return insertId;
            }
   ...
   */ okPacketSuccess(okPacket, info) {
        if (this._responseIndex === 0) {
            ...
            if (info.status & __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$server$2d$status$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MORE_RESULTS_EXISTS"]) {
   ...
   */ readColumn(packet, out, opts, info) {
        this._columns.push(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$column$2d$definition$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](packet, info, this.opts.rowsAsArray));
        // Last column
   ...
   */ setParser() {
        ...
        if (this.opts.typeCast) {
            ...
            const dataParser = this.binary ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$decoder$2f$binary$2d$decoder$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parser"] : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$decoder$2f$text$2d$decoder$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parser"];
            for(let i = 0; i < this._columnCount; i++){
   ...
   */ checkDuplicates() {
        if (this.opts.checkDuplicate) {
            ...
            for(let i = 0; i < this._columnCount; i++){
                ...
                if (seen.has(header)) {
                    this.throwUnexpectedError(`Error in results, duplicate field name \`${header}\`.\n(see option \`checkDuplicate\`)`, false, null, '42000', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_DUPLICATE_FIELD);
                    return;
                }
                seen.add(header);
            }
   ...
   */ checkNestTablesDuplicatesAndPrivateFields() {
        ...
        for(let i = 0; i < this._columnCount; i++){
            if (privateFields.has(this.tableHeader[i][0])) {
                this.throwUnexpectedError(`Use of \`${this.tableHeader[i][0]}\` is not permitted with option \`nestTables\``, false, null, '42000', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_PRIVATE_FIELDS_USE);
   ...
   */ readIntermediateEOF(packet, out, opts, info) {
        if (packet.peek() !== 0xfe) {
            return this.throwNewError('Error in protocol, expected EOF packet', true, info, '42000', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_EOF_EXPECTED);
        }
        ...
        packet.skip(3);
        info.status = packet.readUInt16();
        this.isOutParameter = info.status & __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$server$2d$status$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PS_OUT_PARAMS"];
   ...
   */ readResultSetRow(packet, out, opts, info) {
    ...
    resultSetEndingPacketResult(info) {
        if (this.opts.metaAsArray) {
            ...
            // ]
            if (info.status & __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$server$2d$status$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MORE_RESULTS_EXISTS"] || this.isOutParameter) {
   ...
   */ displaySql() {
    ...
    parseRowAsArray(packet) {
        ...
        const nullBitMap = this.binary ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$decoder$2f$binary$2d$decoder$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["newRow"](packet, this._columns) : null;
        for(let i = 0; i < this._columnCount; i++){
    ...
    parseRowStdBinary(packet) {
        const nullBitMap = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$decoder$2f$binary$2d$decoder$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["newRow"](packet, this._columns);
        const row = {};
        for(let i = 0; i < this._columnCount; i++){
    ...
    readCastValue(column, packet, opts, unexpectedError, nullBitmap, index) {
        if (this.binary) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$decoder$2f$binary$2d$decoder$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["castWrapper"](column, packet, opts, nullBitmap, index);
        } else {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$decoder$2f$text$2d$decoder$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["castWrapper"](column, packet, opts, nullBitmap, index);
        }
        const dataParser = this.binary ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$decoder$2f$binary$2d$decoder$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parser"] : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$decoder$2f$text$2d$decoder$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parser"];
    ...
    readLocalInfile(packet, out, opts, info) {
        ...
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$parse$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["validateFileName"])(this.sql, this.initialValues, fileName)) {
            out.writeEmptyPacket();
            const error = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createError"]("LOCAL INFILE wrong filename. '" + fileName + "' doesn't correspond to query " + this.sql + '. Query cancelled. Check for malicious server / proxy', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_LOCAL_INFILE_WRONG_FILENAME, info, 'HY000', this.sql);
        ...
        let stream;
        try {
            stream = this.opts.infileStreamFactory ? this.opts.infileStreamFactory(fileName) : __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$fs__$5b$external$5d$__$28$node$3a$fs$2c$__cjs$29$__["default"].createReadStream(fileName);
        } catch (e) {
            out.writeEmptyPacket();
            const error = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createError"](`LOCAL INFILE infileStreamFactory failed`, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_LOCAL_INFILE_NOT_READABLE, info, '22000', this.opts.logParam ? this.displaySql() : this.sql);
            error.cause = e;
            process.nextTick(this.reject, error);
            this.reject = null;
            this.resolve = null;
        ...
        stream.on('error', (function(err) {
            out.writeEmptyPacket();
            const error = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createError"](`LOCAL INFILE command failed: ${err.message}`, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_LOCAL_INFILE_NOT_READABLE, info, '22000', this.sql);
            process.nextTick(this.reject, error);
            this.reject = null;
            this.resolve = null;
        }).bind(this));
...
"[project]/node_modules/mariadb/lib/cmd/query.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$parser$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/cmd/parser.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/misc/errors.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$parse$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/misc/parse.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$encoder$2f$text$2d$encoder$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/cmd/encoder/text-encoder.js [app-route] (ecmascript)");
 ...
 */ class Query extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$parser$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"] {
    constructor(resolve, reject, connOpts, cmdParam){
   ...
   */ start(out, opts, info) {
        ...
        if (this.opts.namedPlaceholders) {
            try {
                const parsed = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$parse$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["splitQueryPlaceholder"])(this.encodedSql, info, this.initialValues, this.opts.logParam ? this.displaySql.bind(this) : ()=>this.sql);
            ...
            this.paramPositions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$parse$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["splitQuery"])(this.encodedSql);
        ...
        for(this.valueIdx = 0; this.valueIdx < len;){
            ...
            switch(typeof value){
                ...
                case 'object':
                    ...
                    if (Object.prototype.toString.call(value) === '[object Date]') {
                        out.writeStringAscii(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$encoder$2f$text$2d$encoder$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].getLocalDate(value));
                    } else if (Buffer.isBuffer(value)) {
                        out.writeStringAscii("_BINARY '");
                        out.writeBufferEscape(value);
                        out.writeInt8(QUOTE);
                        ...
                        for(let i = 0; i < value.length; i++){
                            ...
                            if (value[i] == null) {
                                out.writeStringAscii('NULL');
                            } else __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$encoder$2f$text$2d$encoder$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].writeParam(out, value[i], opts, info);
                        }
                        if (opts.arrayParenthesis) {
                            out.writeStringAscii(')');
                        }
                        ...
                        if (value.type != null && [
                            ...
                            switch(value.type){
                                case 'Point':
                                    out.writeStringAscii(prefix + "PointFromText('POINT(" + __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$encoder$2f$text$2d$encoder$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].geoPointToString(value.coordinates) + ")')");
                                    break;
                                case 'LineString':
                                    out.writeStringAscii(prefix + "LineFromText('LINESTRING(" + __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$encoder$2f$text$2d$encoder$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].geoArrayPointToString(value.coordinates) + ")')");
                                    break;
                                case 'Polygon':
                                    out.writeStringAscii(prefix + "PolygonFromText('POLYGON(" + __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$encoder$2f$text$2d$encoder$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].geoMultiArrayPointToString(value.coordinates) + ")')");
                                    break;
                                case 'MultiPoint':
                                    out.writeStringAscii(prefix + "MULTIPOINTFROMTEXT('MULTIPOINT(" + __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$encoder$2f$text$2d$encoder$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].geoArrayPointToString(value.coordinates) + ")')");
                                    break;
                                case 'MultiLineString':
                                    out.writeStringAscii(prefix + "MLineFromText('MULTILINESTRING(" + __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$encoder$2f$text$2d$encoder$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].geoMultiArrayPointToString(value.coordinates) + ")')");
                                    break;
                                case 'MultiPolygon':
                                    out.writeStringAscii(prefix + "MPolyFromText('MULTIPOLYGON(" + __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$encoder$2f$text$2d$encoder$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].geoMultiPolygonToString(value.coordinates) + ")')");
                                    break;
                                case 'GeometryCollection':
                                    out.writeStringAscii(prefix + "GeomCollFromText('GEOMETRYCOLLECTION(" + __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$encoder$2f$text$2d$encoder$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].geometricCollectionToString(value.geometries) + ")')");
                                    break;
                            }
                        } else if (String === value.constructor) {
                            out.writeStringEscapeQuote(value);
                            ...
                            if (opts.permitSetMultiParamEntries) {
                                ...
                                for(let key in value){
                                    ...
                                    if (val == null) {
                                        ...
                                        out.writeStringAscii('=');
                                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$encoder$2f$text$2d$encoder$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].writeParam(out, val, opts, info);
                                    }
                                }
                                if (first) out.writeStringEscapeQuote(JSON.stringify(value));
                            } else {
        ...
        if (this.opts.timeout) {
            if (info.isMariaDB()) {
                if (info.hasMinVersion(10, 1, 2)) {
                    ...
                    this.sendCancelled(`Cannot use timeout for xpand/MariaDB server before 10.1.2. timeout value: ${this.opts.timeout}`, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_TIMEOUT_NOT_SUPPORTED, info);
                    return false;
                }
            } else {
                //not available for MySQL
                // max_execution time exist, but only for select, and as hint
                this.sendCancelled(`Cannot use timeout for MySQL server. timeout value: ${this.opts.timeout}`, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_TIMEOUT_NOT_SUPPORTED, info);
                return false;
            }
        }
        return true;
   ...
   */ validateParameters(info) {
        ...
        if (this.paramPositions.length / 2 > this.values.length) {
            this.sendCancelled(`Parameter at position ${this.values.length + 1} is not set`, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_MISSING_PARAMETER, info);
            return false;
        }
        return true;
    }
    _paramWritten(out, info) {
        while(true){
            if (this.valueIdx === this.paramPositions.length / 2) {
                ...
                //********************************************
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$encoder$2f$text$2d$encoder$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].writeParam(out, value, this.opts, info);
            }
        }
    }
    _stream(socket, options) {
        ...
        this.inStream = new __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$stream__$5b$external$5d$__$28$node$3a$stream$2c$__cjs$29$__["Readable"](options);
...
"[project]/node_modules/mariadb/lib/cmd/encoder/binary-encoder.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const __TURBOPACK__default__export__ = BinaryEncoder;
}),
"[project]/node_modules/mariadb/lib/cmd/class/prepare-wrapper.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const __TURBOPACK__default__export__ = PrepareWrapper;
}),
"[project]/node_modules/mariadb/lib/cmd/class/prepare-cache-wrapper.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$class$2f$prepare$2d$wrapper$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/cmd/class/prepare-wrapper.js [app-route] (ecmascript)");
//  SPDX-License-Identifier: LGPL-2.1-or-later
//  Copyright (c) 2015-2024 MariaDB Corporation Ab
'use strict';
;
 ...
 */ class PrepareCacheWrapper {
    ...
    incrementUse() {
        this.#use += 1;
        return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$class$2f$prepare$2d$wrapper$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](this, this.#prepare);
    }
    unCache() {
        this.#cached = false;
        if (this.#use === 0) {
...
const __TURBOPACK__default__export__ = PrepareCacheWrapper;
}),
"[project]/node_modules/mariadb/lib/cmd/execute.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$parser$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/cmd/parser.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/misc/errors.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$encoder$2f$binary$2d$encoder$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/cmd/encoder/binary-encoder.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/const/field-type.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$parse$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/misc/parse.js [app-route] (ecmascript)");
//  SPDX-License-Identifier: LGPL-2.1-or-later
//  Copyright (c) 2015-2025 MariaDB Corporation Ab
 ...
 */ class Execute extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$parser$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"] {
   ...
   */ start(out, opts, info) {
        ...
        if (this.opts.namedPlaceholders) {
            if (this.prepare) {
                ...
                const res = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$parse$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["searchPlaceholder"](this.sql);
        ...
        for(let i = 0; i < this.parameterCount; i++){
            ...
            if (val && val.type != null && GEOJSON_TYPES.has(val.type)) {
                const geoBuff = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$encoder$2f$binary$2d$encoder$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].getBufferFromGeometryValue(val);
                if (geoBuff == null) {
                    this.values[i] = null;
                    val = null;
                } else {
   ...
   */ validateParameters(info) {
        ...
        if (this.parameterCount > this.values.length) {
            this.sendCancelled(`Parameter at position ${this.values.length} is not set\\nsql: ${this.opts.logParam ? this.displaySql() : this.sql}`, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_MISSING_PARAMETER, info);
            return false;
        }
        ...
        if (this.opts.namedPlaceholders && this.placeHolderIndex) {
            for(let i = 0; i < this.parameterCount; i++){
                if (this.values[i] === undefined) {
                    ...
                    this.sendCancelled(errMsg, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_PARAMETER_UNDEFINED, info);
                    return false;
                }
            }
        }
...
const NULL_PARAM_TYPE = new ParameterType(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["VAR_STRING"], null, true);
const BOOLEAN_TYPE = new ParameterType(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TINY"], (out, value)=>out.writeInt8(value ? 0x01 : 0x00));
const BIG_BIGINT_TYPE = new ParameterType(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NEWDECIMAL"], (out, value)=>out.writeLengthEncodedString(value.toString()));
const BIGINT_TYPE = new ParameterType(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BIGINT"], (out, value)=>out.writeBigInt(value));
const INT_TYPE = new ParameterType(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["INT"], (out, value)=>out.writeInt32(value));
const DOUBLE_TYPE = new ParameterType(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DOUBLE"], (out, value)=>out.writeDouble(value));
const STRING_TYPE = new ParameterType(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["VAR_STRING"], (out, value)=>out.writeLengthEncodedString(value));
const STRING_TOSTR_TYPE = new ParameterType(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["VAR_STRING"], (out, value)=>out.writeLengthEncodedString(value.toString()));
const DATE_TYPE = new ParameterType(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DATETIME"], (out, value)=>out.writeBinaryDate(value));
const BLOB_TYPE = new ParameterType(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BLOB"], (out, value)=>out.writeLengthEncodedBuffer(value));
const LONGBLOB_TYPE = new ParameterType(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BLOB"], null);
const STRING_FCT_TYPE = new ParameterType(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["VAR_STRING"], (out, value)=>out.writeLengthEncodedString(String(value.toSqlString())));
const STREAM_TYPE = new ParameterType(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BLOB"], null);
const STRINGIFY_TYPE = new ParameterType(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["VAR_STRING"], (out, value)=>out.writeLengthEncodedString(JSON.stringify(value)));
const __TURBOPACK__default__export__ = Execute;
}),
"[project]/node_modules/mariadb/lib/cmd/execute-stream.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$execute$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/cmd/execute.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$stream__$5b$external$5d$__$28$node$3a$stream$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/node:stream [external] (node:stream, cjs)");
//  SPDX-License-Identifier: LGPL-2.1-or-later
//  Copyright (c) 2015-2024 MariaDB Corporation Ab
'use strict';
 ...
 * see: https://mariadb.com/kb/en/com_stmt_execute/
 */ class ExecuteStream extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$execute$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"] {
    constructor(cmdParam, connOpts, prepare, socket){
        super(()=>{}, ()=>{}, connOpts, cmdParam, prepare);
        this.socket = socket;
        this.inStream = new __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$stream__$5b$external$5d$__$28$node$3a$stream$2c$__cjs$29$__["Readable"]({
            objectMode: true,
            read: ()=>{
                this.socket.resume();
            }
...
const __TURBOPACK__default__export__ = ExecuteStream;
}),
"[project]/node_modules/mariadb/lib/cmd/class/prepare-result-packet.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/misc/errors.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$execute$2d$stream$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/cmd/execute-stream.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$parser$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/cmd/parser.js [app-route] (ecmascript)");
//  SPDX-License-Identifier: LGPL-2.1-or-later
//  Copyright (c) 2015-2024 MariaDB Corporation Ab
'use strict';
 ...
 */ class PrepareResultPacket {
        ...
        if (this.isClose()) {
            ...
            if (this.conn.opts.logParam) {
                if (this.query.length > this.conn.opts.debugLen) {
                    ...
                    sql = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$parser$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].logParameters(this.conn.opts, sqlMsg, values);
                }
            }
            const error = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createError"](`Execute fails, prepare command as already been closed`, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_PREPARE_CLOSED, null, '22000', sql);
            if (!_cb) {
    ...
    executeStream(values, opts, cb, stack) {
        ...
        if (stack) cmdParam.stack = stack;
        const cmd = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$execute$2d$stream$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](cmdParam, this.conn.opts, this, this.conn.socket);
...
const __TURBOPACK__default__export__ = PrepareResultPacket;
}),
"[project]/node_modules/mariadb/lib/cmd/prepare.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$parse$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/misc/parse.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$encoder$2f$binary$2d$encoder$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/cmd/encoder/binary-encoder.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$class$2f$prepare$2d$cache$2d$wrapper$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/cmd/class/prepare-cache-wrapper.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$class$2f$prepare$2d$result$2d$packet$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/cmd/class/prepare-result-packet.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$server$2d$status$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/const/server-status.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/misc/errors.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$column$2d$definition$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/cmd/column-definition.js [app-route] (ecmascript)");
//  SPDX-License-Identifier: LGPL-2.1-or-later
 ...
 */ class Prepare extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$parser$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"] {
    constructor(resolve, reject, connOpts, cmdParam, conn){
        super(resolve, reject, connOpts, cmdParam);
        this.encoder = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$encoder$2f$binary$2d$encoder$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](this.opts);
        this.binary = true;
        this.conn = conn;
   ...
   */ start(out, opts, info) {
        ...
        if (this.opts.namedPlaceholders) {
            const res = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$parse$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["searchPlaceholder"])(this.sql);
            this.sql = res.sql;
            this.placeHolderIndex = res.placeHolderIndex;
        }
        out.startPacket(this);
    ...
    successPrepare(info, opts) {
        let prepare = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$class$2f$prepare$2d$result$2d$packet$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](this.statementId, this.parameterCount, this._columns, info.database, this.sql, this.placeHolderIndex, this.conn);
        if (this.conn.prepareCache) {
            let cached = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$class$2f$prepare$2d$cache$2d$wrapper$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](prepare);
   ...
   */ readPrepareResultPacket(packet, out, opts, info) {
        switch(packet.peek()){
            ...
            default:
                info.status |= __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$server$2d$status$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["STATUS_IN_TRANS"];
                this.onPacketReceive = this.readResponsePacket;
                return this.throwError(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_UNEXPECTED_PACKET, info);
        }
    }
    readPrepareColumnsPacket(packet, out, opts, info) {
        this.columnNo--;
        this._columns.push(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$column$2d$definition$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](packet, info, opts.rowsAsArray));
        if (this.columnNo === 0) {
            if (info.eofDeprecated) {
                return this.successPrepare(info, opts);
            }
...
"[project]/node_modules/mariadb/lib/cmd/close-prepare.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ class ClosePrepare extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$command$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"] {
...
const __TURBOPACK__default__export__ = ClosePrepare;
}),
"[project]/node_modules/mariadb/lib/cmd/batch-bulk.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ class BatchBulk extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$parser$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"] {
   ...
   */ handleTimeoutError(info) {
        this.bulkPacketNo = 1;
        this.sending = false;
        return this.sendCancelled('Cannot use timeout for Batch statement', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_TIMEOUT_NOT_SUPPORTED);
    }
    /**
   ...
   */ parameterHeaderFromValue(value, parameterCount) {
        ...
        for(let i = 0; i < parameterCount; i++){
            const val = value[i];
            if (val == null) {
                parameterHeaderType[i] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["VAR_STRING"];
                continue;
            }
            const type = typeof val;
            switch(type){
                case 'boolean':
                    parameterHeaderType[i] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TINY"];
                    break;
                case 'bigint':
                    parameterHeaderType[i] = val >= 2n ** 63n ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NEWDECIMAL"] : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BIGINT"];
                    break;
                case 'number':
                    if (Number.isInteger(val) && val >= -2147483648 && val < 2147483647) {
                        parameterHeaderType[i] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["INT"];
                    } else {
                        parameterHeaderType[i] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DOUBLE"];
                    }
                    break;
                case 'string':
                    parameterHeaderType[i] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["VAR_STRING"];
                ...
                case 'object':
                    ...
                    break;
                default:
                    parameterHeaderType[i] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BLOB"];
            }
        }
   ...
   */ getObjectFieldType(val) {
        if (Object.prototype.toString.call(val) === '[object Date]') {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DATETIME"];
        }
        if (Buffer.isBuffer(val)) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BLOB"];
        }
        if (typeof val.toSqlString === 'function') {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["VAR_STRING"];
        }
   ...
   */ checkSameHeader(parameterHeaderType, value, parameterCount) {
        for(let i = 0; i < parameterCount; i++){
            ...
            switch(type){
                case 'boolean':
                    if (parameterHeaderType[i] !== __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TINY"]) return false;
                    break;
                case 'bigint':
                    if (val >= 2n ** 63n) {
                        if (parameterHeaderType[i] !== __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["VAR_STRING"]) return false;
                    } else {
                        if (parameterHeaderType[i] !== __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BIGINT"]) return false;
                    }
                    break;
                case 'number':
                    if (Number.isInteger(val) && val >= -2147483648 && val < 2147483647) {
                        if (parameterHeaderType[i] !== __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["INT"]) return false;
                    } else {
                        if (parameterHeaderType[i] !== __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DOUBLE"]) return false;
                    }
                    break;
                case 'string':
                    if (parameterHeaderType[i] !== __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["VAR_STRING"]) return false;
                ...
                case 'object':
                    ...
                    break;
                default:
                    if (parameterHeaderType[i] !== __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BLOB"]) return false;
            }
        }
        return true;
    }
   ...
   */ checkObjectHeaderType(val, headerType) {
        if (Object.prototype.toString.call(val) === '[object Date]') {
            return headerType === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TIMESTAMP"];
        }
        if (Buffer.isBuffer(val)) {
            return headerType === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BLOB"];
        }
        if (typeof val.toSqlString === 'function') {
            return headerType === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["VAR_STRING"];
        }
        if (val.type != null && GEOJSON_TYPES.includes(val.type)) {
            return headerType === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$field$2d$type$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BLOB"];
        }
   ...
   */ sendComStmtBulkExecute(out, opts, info) {
        ...
        main_loop: while(true){
            ...
            this.useUnitResult = (info.clientCapabilities & __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$capabilities$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BULK_UNIT_RESULTS"]) > 0;
                ...
                for(let i = 0; i < parameterCount; i++){
                    ...
                    if (param != null) {
                        ...
                        if (param.type != null && GEOJSON_TYPES.includes(param.type)) {
                            ...
                            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$encoder$2f$binary$2d$encoder$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].writeParam(out, param, this.opts, info);
                        }
                    } else {
   ...
   */ writeGeoJSONParam(out, param, info) {
        const geoBuff = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$encoder$2f$binary$2d$encoder$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].getBufferFromGeometryValue(param);
        if (geoBuff == null) {
            out.writeInt8(0x01); // value is null
        } else {
            out.writeInt8(0x00); // value follows
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$encoder$2f$binary$2d$encoder$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].writeParam(out, paramBuff, this.opts, info);
        }
    }
    /**
   ...
   */ displaySql() {
        ...
        for(let i = 0; i < this.initialValues.length; i++){
            ...
            sqlMsg = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$parser$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].logParameters(this.opts, sqlMsg, param);
   ...
   */ processUnitResults() {
        if (this.opts.fullResult === undefined || this.opts.fullResult === true) {
            ...
            this._rows.forEach((row)=>{
                row.forEach((unitRow)=>{
                    rs.push(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$class$2f$ok$2d$packet$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](Number(unitRow['Affected_rows']), BigInt(unitRow['Id']), 0));
                });
            });
            ...
            const rs = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$class$2f$ok$2d$packet$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](totalAffectedRows, BigInt(this._rows[0][0]['Id']), 0);
            this.successEnd(this.opts.metaAsArray ? [
                rs,
                []
            ] : rs);
   ...
   */ processAggregatedResults() {
        ...
        const rs = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$class$2f$ok$2d$packet$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](totalAffectedRows, this._rows[0].insertId, this._rows[this._rows.length - 1].warningStatus);
        this.successEnd(this.opts.metaAsArray ? [
            rs,
            []
        ] : rs);
   ...
   */ throwError(err, info) {
        ...
        if (!this.firstError) {
            ...
            if (this.cmdParam.stack) {
                err = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createError"](err.message, err.errno, info, err.sqlState, this.opts.logParam ? this.displaySql() : this.sql, err.fatal, this.cmdParam.stack, false);
            }
            this.firstError = err;
        }
        if (!this.sending && this.bulkPacketNo === 0) {
   ...
   */ validateParameters(info) {
        ...
        for(let r = 0; r < this.values.length; r++){
            ...
            if (this.values[r].length < nbParameter) {
                this.emit('send_end');
                this.throwNewError(`Expect ${nbParameter} parameters, but at index ${r}, parameters only contains ${this.values[r].length}\n ${this.opts.logParam ? this.displaySql() : this.sql}`, false, info, 'HY000', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_PARAMETER_UNDEFINED);
                return false;
            }
        }
        return true;
...
const __TURBOPACK__default__export__ = BatchBulk;
}),
"[project]/node_modules/mariadb/lib/cmd/change-user.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$handshake$2f$auth$2f$native$2d$password$2d$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/cmd/handshake/auth/native-password-auth.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$collations$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/const/collations.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$handshake$2f$authentication$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/cmd/handshake/authentication.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$package$2e$json$2e5b$json$5d2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/package.json.[json].mjs [app-route] (ecmascript)");
//  SPDX-License-Identifier: LGPL-2.1-or-later
//  Copyright (c) 2015-2024 MariaDB Corporation Ab
// noinspection JSBitwiseOperatorUsage
 ...
 */ class ChangeUser extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$handshake$2f$authentication$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"] {
    ...
    start(out, opts, info) {
        ...
        switch(info.defaultPluginName){
            ...
            case '':
                ...
                break;
            case 'client_ed25519':
                authToken = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$handshake$2f$auth$2f$ed25519$2d$password$2d$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].encryptPassword(pwd, info.seed);
                break;
            default:
        ...
        out.writeInt8(0);
        if (info.serverCapabilities & __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$capabilities$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SECURE_CONNECTION"]) {
            out.writeInt8(authToken.length);
            out.writeBuffer(authToken, 0, authToken.length);
        } else {
            out.writeBuffer(authToken, 0, authToken.length);
        ...
        if (this.opts.collation) {
            ...
            if (info.collation.charset !== 'utf8' || info.collation.maxLength === 3) {
                info.collation = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$collations$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].fromIndex(224);
            }
        }
        ...
        if (info.clientCapabilities & __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$capabilities$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["CONNECT_ATTRS"]) {
            ...
            writeAttribute(out, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$package$2e$json$2e5b$json$5d2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].version, encoding);
   ...
   */ configAssign(connOpts, cmdOpts) {
        ...
        if (cmdOpts.charset && typeof cmdOpts.charset === 'string') {
            this.opts.collation = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$collations$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].fromCharset(cmdOpts.charset.toLowerCase());
            if (this.opts.collation === undefined) {
                this.opts.collation = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$collations$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].fromName(cmdOpts.charset.toUpperCase());
                if (this.opts.collation !== undefined) {
            ...
            this.opts.collation = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$collations$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].fromName(initial.toUpperCase());
            if (this.opts.collation === undefined) throw new RangeError("Unknown collation '" + initial + "'");
        } else {
            this.opts.collation = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$collations$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].fromIndex(cmdOpts.charsetNumber) || connOpts.collation;
        }
        connOpts.password = cmdOpts.password;
    }
}
function writeAttribute(out, val, encoding) {
    let param = Buffer.isEncoding(encoding) ? Buffer.from(val, encoding) : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$iconv$2d$lite$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].encode(val, encoding);
    out.writeLengthCoded(param.length);
    out.writeBuffer(param, 0, param.length);
}
const __TURBOPACK__default__export__ = ChangeUser;
}),
"[project]/node_modules/mariadb/lib/const/connection_status.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const CONNECTED = 5;
const TERMINATING = 6;
const TERMINATING_SOCKET = 7;
const CLOSED = 8;
}),
"[project]/node_modules/mariadb/lib/lru-prepare-cache.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$node_modules$2f$lru$2d$cache$2f$dist$2f$esm$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/node_modules/lru-cache/dist/esm/index.js [app-route] (ecmascript)");
//  SPDX-License-Identifier: LGPL-2.1-or-later
//  Copyright (c) 2015-2024 MariaDB Corporation Ab
'use strict';
;
 ...
 */ class LruPrepareCache {
   ...
   */ constructor(info, prepareCacheLength){
        ...
        this.#info = info;
        this.#lruCache = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$node_modules$2f$lru$2d$cache$2f$dist$2f$esm$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["LRUCache"]({
...
const __TURBOPACK__default__export__ = LruPrepareCache;
}),
"[project]/node_modules/mariadb/lib/connection.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$events__$5b$external$5d$__$28$node$3a$events$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/node:events [external] (node:events, cjs)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$denque$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/denque/index.js [app-route] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$io$2f$packet$2d$input$2d$stream$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/io/packet-input-stream.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$io$2f$packet$2d$output$2d$stream$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/io/packet-output-stream.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$io$2f$compression$2d$input$2d$stream$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/io/compression-input-stream.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$io$2f$compression$2d$output$2d$stream$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/io/compression-output-stream.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$server$2d$status$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/const/server-status.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$connection$2d$information$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/misc/connection-information.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$tls__$5b$external$5d$__$28$node$3a$tls$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/node:tls [external] (node:tls, cjs)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/misc/errors.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/misc/utils.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$capabilities$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/const/capabilities.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$config$2f$connection$2d$options$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/config/connection-options.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$handshake$2f$authentication$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/cmd/handshake/authentication.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$quit$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/cmd/quit.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$ping$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/cmd/ping.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$reset$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/cmd/reset.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$query$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/cmd/query.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$prepare$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/cmd/prepare.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$class$2f$ok$2d$packet$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/cmd/class/ok-packet.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$execute$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/cmd/execute.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$close$2d$prepare$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/cmd/close-prepare.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$batch$2d$bulk$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/cmd/batch-bulk.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$change$2d$user$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/cmd/change-user.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$connection_status$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/const/connection_status.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$lru$2d$prepare$2d$cache$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/lru-prepare-cache.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$fs__$5b$external$5d$__$28$node$3a$fs$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/node:fs [external] (node:fs, cjs)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$parse$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/misc/parse.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$collations$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/const/collations.js [app-route] (ecmascript)");
//  SPDX-License-Identifier: LGPL-2.1-or-later
...
const convertFixedTime = function(tz, conn) {
    if (tz === 'UTC' || tz === 'Etc/UTC' || tz === 'Z' || tz === 'Etc/GMT') {
        ...
        if (isNaN(diff)) {
            throw __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createFatalError"](`Automatic timezone setting fails. wrong Server timezone '${tz}' conversion to +/-HH:00 conversion.`, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_WRONG_AUTO_TIMEZONE, conn.info);
        }
 ...
 *
 */ class Connection extends __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$events__$5b$external$5d$__$28$node$3a$events$2c$__cjs$29$__["default"] {
    opts;
    sendQueue = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$denque$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"]();
    receiveQueue = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$denque$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"]();
    waitingAuthenticationQueue = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$denque$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"]();
    status = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$connection_status$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NOT_CONNECTED"];
    socket = null;
    timeout = null;
    addCommand;
    streamOut;
    ...
    constructor(options){
        super();
        this.opts = Object.assign(new __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$events__$5b$external$5d$__$28$node$3a$events$2c$__cjs$29$__["default"](), options);
        this.info = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$connection$2d$information$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](this.opts, this.redirect.bind(this));
        this.prepareCache = this.opts.prepareCacheLength > 0 ? new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$lru$2d$prepare$2d$cache$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](this.info, this.opts.prepareCacheLength) : null;
        this.addCommand = this.addCommandQueue;
        this.streamOut = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$io$2f$packet$2d$output$2d$stream$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](this.opts, this.info);
        this.streamIn = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$io$2f$packet$2d$input$2d$stream$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](this.unexpectedPacket.bind(this), this.receiveQueue, this.streamOut, this.opts, this.info);
        this._boundSendNextCmd = this._sendNextCmdImmediate.bind(this);
        this.on('close_prepare', this._closePrepare.bind(this));
        this.escape = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["escape"].bind(this, this.opts, this.info);
        this.escapeId = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["escapeId"].bind(this, this.opts, this.info);
    }
    //*****************************************************************
    // public methods
    //*****************************************************************
   ...
   */ connect() {
        const conn = this;
        this.status = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$connection_status$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["CONNECTING"];
        ...
        return new Promise(function(resolve, reject) {
            ...
            const authentication = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$handshake$2f$authentication$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](authenticationParam, conn.opts.host, conn.authSucceedHandler.bind(conn), conn.authFailHandler.bind(conn), conn.createSecureContext.bind(conn), conn.getSocket.bind(conn));
   ...
   */ executePromise(cmdParam, prepare, resolve, reject) {
        const cmd = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$execute$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](resolve, this._logAndReject.bind(this, reject), this.opts, cmdParam, prepare);
   ...
   */ handleMissingSqlError(reject) {
        const err = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createError"]('sql parameter is mandatory', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_UNDEFINED_SQL, this.info, 'HY000', null, false);
   ...
   */ handleMissingValuesError(cmdParam, reject) {
        ...
        const err = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createError"]('Batch must have values set', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_BATCH_WITH_NO_VALUES, this.info, 'HY000', debugSql, false, cmdParam.stack);
        this._logAndReject(reject, err);
    }
    /**
   ...
   */ executeBulkPromise(cmdParam, prepare, opts, resolve, reject) {
        const cmd = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$batch$2d$bulk$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"]((res)=>{
            prepare.close();
            return resolve(res);
        }, (err)=>{
            prepare.close();
   ...
   */ processBatchResults(results, cmdOpt, cmdParam, resolve) {
        ...
        if (fullResult) {
            if (cmdOpt.metaAsArray) {
                const aggregateResults = results.reduce((accumulator, currentValue)=>{
                    ...
                    } else if (currentValue[0] instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$class$2f$ok$2d$packet$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"]) {
                        accumulator.push(currentValue[0]);
                    } else {
                        accumulator.push([
                            currentValue[0]
                ...
                const aggregateResults = results.reduce((accumulator, currentValue)=>{
                    if (currentValue instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$class$2f$ok$2d$packet$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"]) {
        ...
        if (firstResult instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$class$2f$ok$2d$packet$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"]) {
   ...
   */ aggregateOkPackets(results, cmdOpt, resolve) {
        ...
        if (cmdOpt.metaAsArray) {
            ...
            resolve([
                new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$class$2f$ok$2d$packet$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](affectedRows, insertId, warningStatus),
                []
            ]);
        } else {
            affectedRows = results.reduce((sum, result)=>sum + result.affectedRows, 0);
            resolve(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$class$2f$ok$2d$packet$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](affectedRows, insertId, warningStatus));
        }
    }
    /**
   ...
   */ ping(cmdParam, resolve, reject) {
        ...
        if (cmdParam.opts && cmdParam.opts.timeout !== undefined) {
            ...
            if (cmdParam.opts.timeout < 0) {
                const err = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createError"]('Ping cannot have negative timeout value', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_BAD_PARAMETER_VALUE, this.info, '0A000');
                this._logAndReject(reject, err);
                return;
            }
            let timeoutRef = setTimeout((function() {
                ...
                const err = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createFatalError"]('Ping timeout', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_PING_TIMEOUT, this.info, '0A000');
                // Close connection properly
                this.addCommand = this.addCommandDisabled;
                clearTimeout(this.timeout);
                if (this.status <= __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$connection_status$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TERMINATING"]) {
                    this.sendQueue.clear();
                    this.status = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$connection_status$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["CLOSED"];
                    this.socket.destroy();
                }
                this.clear();
                this._logAndReject(reject, err);
            ...
            this.addCommand(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$ping$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](cmdParam, ()=>{
        ...
        this.addCommand(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$ping$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](cmdParam, resolve, reject), true);
    }
    /**
   ...
   */ reset(cmdParam, resolve, reject) {
        if (this.info.isMariaDB() && this.info.hasMinVersion(10, 2, 4) || !this.info.isMariaDB() && this.info.hasMinVersion(5, 7, 3)) {
            const conn = this;
            const resetCmd = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$reset$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](cmdParam, ()=>{
   ...
   * @returns {boolean}
   */ isValid() {
        return this.status === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$connection_status$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["CONNECTED"];
    }
    /**
   ...
   */ end(cmdParam, resolve, reject) {
        this.addCommand = this.addCommandDisabled;
        clearTimeout(this.timeout);
        if (this.status < __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$connection_status$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TERMINATING_SOCKET"] && this.status !== __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$connection_status$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NOT_CONNECTED"]) {
            this.status = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$connection_status$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TERMINATING_SOCKET"];
            const ended = ()=>{
                this.status = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$connection_status$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["CLOSED"];
                this.socket.destroy();
                this.socket.unref();
            ...
            const quitCmd = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$quit$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](cmdParam, ended, ended);
   ...
   */ destroy() {
        this.addCommand = this.addCommandDisabled;
        clearTimeout(this.timeout);
        if (this.status < __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$connection_status$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TERMINATING_SOCKET"]) {
            this.status = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$connection_status$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TERMINATING_SOCKET"];
            this.sendQueue.clear();
            if (this.receiveQueue.length > 0) {
                ...
                killCon.connect().then(()=>{
                    ...
                    new Promise(killCon.query.bind(killCon, {
                        ...
                        const destroyError = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createFatalError"]('Connection destroyed, command was killed', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_CMD_NOT_EXECUTED_DESTROYED, self.info);
                        ...
                        self.status = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$connection_status$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["CLOSED"];
                        self.clear();
                    ...
                    const quitCmd = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$quit$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](ended, ended);
    ...
    format(sql, values) {
        const err = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createError"]('"Connection.format intentionally not implemented. please use Connection.query(sql, values), ' + 'it will be more secure and faster', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_NOT_IMPLEMENTED_FORMAT, this.info, '0A000');
        if (this.opts.logger.error) this.opts.logger.error(err);
        throw err;
    }
    //*****************************************************************
   ...
   */ _canUseBulk(values, options) {
        ...
        if (options && options.fullResult && (this.info.clientCapabilities & __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$capabilities$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BULK_UNIT_RESULTS"]) === 0n) {
            return false;
        }
        ...
        const serverSupportsBulk = this.info.serverVersion && this.info.serverVersion.mariaDb && this.info.hasMinVersion(10, 2, 7) && (this.info.serverCapabilities & __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$capabilities$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MARIADB_CLIENT_STMT_BULK_OPERATIONS"]) > 0n;
        ...
        if (this.opts.sessionVariables) {
            ...
            if (keys.length > 0) {
                ...
                return new Promise(this.query.bind(this, {
                    ...
                    const err = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createFatalError"](`Error setting session variable (value ${JSON.stringify(this.opts.sessionVariables)}). Error: ${initialErr.message}`, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_SETTING_SESSION_ERROR, this.info, '08S01', sessionQuery);
                    if (this.opts.logger.error) this.opts.logger.error(err);
   ...
   */ handleCharset() {
        ...
        if (!this.opts.charset && this.info.collation && this.info.collation.charset === 'utf8' && this.info.collation.maxLength === 4) {
            this.info.collation = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$collations$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].fromCharset('utf8mb4');
            return Promise.resolve();
        }
        const connCharset = this.opts.charset ? this.opts.charset : 'utf8mb4';
        this.info.collation = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$collations$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].fromCharset(connCharset);
        return new Promise(this.query.bind(this, {
   ...
   */ handleTimezone() {
    ...
    _setSessionTimezone(tz) {
        return new Promise(this.query.bind(this, {
            ...
            const er = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createError"](`setting timezone '${tz}' fails on server.\n look at https://mariadb.com/kb/en/mysql_tzinfo_to_sql/ to load IANA timezone. `, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_WRONG_IANA_TIMEZONE, this.info, '08S01', null, false, null, null, err);
    ...
    checkServerVersion() {
        ...
        return new Promise(this.query.bind(this, {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$connection$2d$information$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].parseVersionString(this.info);
            return Promise.resolve();
        }).bind(this));
    }
    executeInitQuery() {
        if (this.opts.initSql) {
            ...
            return Promise.all(initialPromises).catch((initialErr)=>{
                const err = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createFatalError"](`Error executing initial sql command: ${initialErr.message}`, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_INITIAL_SQL_ERROR, this.info);
                if (this.opts.logger.error) this.opts.logger.error(err);
                return Promise.reject(err);
            });
        }
        ...
        if (this.opts.queryTimeout) {
            if (this.info.isMariaDB() && this.info.hasMinVersion(10, 1, 2)) {
                ...
                new Promise(this.query.bind(this, {
                    ...
                    const err = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createFatalError"](`Error setting session queryTimeout: ${initialErr.message}`, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_INITIAL_TIMEOUT_ERROR, this.info, '08S01', query);
                    if (this.opts.logger.error) this.opts.logger.error(err);
                    return Promise.reject(err);
                }).bind(this));
            } else {
                const err = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createError"](`Can only use queryTimeout for MariaDB server after 10.1.1. queryTimeout value: ${this.opts.queryTimeout}`, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_TIMEOUT_NOT_SUPPORTED, this.info, 'HY000', this.opts.queryTimeout);
                if (this.opts.logger.error) this.opts.logger.error(err);
                return Promise.reject(err);
            }
        }
   ...
   */ streamInitSocket() {
        ...
        if (this.opts.socketPath) {
            this.socket = __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$net__$5b$external$5d$__$28$node$3a$net$2c$__cjs$29$__["default"].connect(this.opts.socketPath);
            ...
            if (typeof this.opts.stream === 'function') {
                const tmpSocket = this.opts.stream((function(err, stream) {
                    ...
                    this.socket = stream ? stream : __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$net__$5b$external$5d$__$28$node$3a$net$2c$__cjs$29$__["default"].connect(this.opts.port, this.opts.host);
                    this.socketInit();
                }).bind(this));
                if (tmpSocket) {
                ...
                this.authFailHandler(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createError"]('stream option is not a function. stream must be a function with (error, callback) parameter', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_BAD_PARAMETER_VALUE, this.info));
            }
            return;
        } else {
            this.socket = __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$net__$5b$external$5d$__$28$node$3a$net$2c$__cjs$29$__["default"].connect(this.opts.port, this.opts.host);
    ...
    socketInit() {
        ...
        this.socket.on('connect', (function() {
            if (this.status === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$connection_status$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["CONNECTING"]) {
                this.status = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$connection_status$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AUTHENTICATING"];
   ...
   */ authSucceedHandler() {
        ...
        if (this.opts.compress) {
            if (this.info.serverCapabilities & __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$capabilities$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["COMPRESS"]) {
                this.streamOut.setStream(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$io$2f$compression$2d$output$2d$stream$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](this.socket, this.opts, this.info));
                this.streamIn = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$io$2f$compression$2d$input$2d$stream$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](this.streamIn, this.receiveQueue, this.opts, this.info);
                this.socket.removeAllListeners('data');
                this.socket.on('data', this.streamIn.onData.bind(this.streamIn));
            } else if (this.opts.logger.error) {
                this.opts.logger.error(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createError"]("connection is configured to use packet compression, but the server doesn't have this capability", __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_COMPRESSION_NOT_SUPPORTED, this.info));
            }
        }
        this.addCommand = this.opts.pipelining ? this.addCommandEnablePipeline : this.addCommandEnable;
        const conn = this;
        this.status = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$connection_status$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["INIT_CMD"];
        this.executeSessionVariableQuery().then(conn.handleCharset.bind(conn)).then(this.handleTimezone.bind(this)).then(this.checkServerVersion.bind(this)).then(this.executeInitQuery.bind(this)).then(this.executeSessionTimeout.bind(this)).then(()=>{
            clearTimeout(this.timeout);
            conn.status = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$connection_status$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["CONNECTED"];
   ...
   */ createSecureContext(info, callback) {
        info.requireValidCert = this.opts.ssl === true || this.opts.ssl && (this.opts.ssl.rejectUnauthorized === undefined || this.opts.ssl.rejectUnauthorized === true);
        const baseConf = {
            socket: this.socket
        };
        ...
        } else if (info.requireValidCert && info.isMariaDB() && !this.opts.socketPath && Boolean(this.opts.password) && !(this.opts.ssl && this.opts.ssl.ca)) {
        ...
        try {
            const secureSocket = __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$tls__$5b$external$5d$__$28$node$3a$tls$2c$__cjs$29$__["default"].connect(sslOption, callback);
   ...
   */ unexpectedPacket(packet) {
        if (packet && packet.peek() === 0xff) {
            ...
            if (err.fatal && this.status < __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$connection_status$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TERMINATING"]) {
                this.status = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$connection_status$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TERMINATING"];
                this.emit('error', err);
                if (this.opts.logger.error) this.opts.logger.error(err);
                this.end(()=>{}, ()=>{});
            }
        } else if (this.status < __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$connection_status$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TERMINATING"]) {
            this.status = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$connection_status$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TERMINATING"];
            const err = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createFatalError"](`receiving packet from server without active commands\nconn:${this.info.threadId ? this.info.threadId : -1}(${packet.pos},${packet.end})\n${__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["log"](this.opts, packet.buf, packet.pos, packet.end)}`, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_UNEXPECTED_PACKET, this.info);
            if (this.opts.logger.error) this.opts.logger.error(err);
            this.emit('error', err);
            this.destroy();
        }
   ...
   */ connectTimeoutReached(initialConnectionTime) {
        ...
        const err = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createFatalError"](`Connection timeout: failed to create socket after ${Date.now() - initialConnectionTime}ms`, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_CONNECTION_TIMEOUT, this.info, '08S01', null, handshake ? handshake.stack : null);
        if (this.opts.logger.error) this.opts.logger.error(err);
        this.authFailHandler(err);
    }
    /**
   ...
   */ socketTimeoutReached() {
        clearTimeout(this.timeout);
        const err = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createFatalError"]('socket timeout', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_SOCKET_TIMEOUT, this.info);
        if (this.opts.logger.error) this.opts.logger.error(err);
        this.fatalError(err, true);
    }
    /**
   ...
   */ addCommandDisabled(cmd) {
        const err = cmd.throwNewError('Cannot execute new commands: connection closed', true, this.info, '08S01', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_CMD_CONNECTION_CLOSED);
        if (this.opts.logger.error) this.opts.logger.error(err);
    }
    /**
   * Handle socket error.
   ...
   */ socketErrorHandler(err) {
        if (this.status >= __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$connection_status$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TERMINATING_SOCKET"]) return;
        if (this.socket) {
        ...
        if (!err) {
            err = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createFatalError"]('socket has unexpectedly been closed', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_SOCKET_UNEXPECTED_CLOSE, this.info);
        } else {
            err.fatal = true;
            err.sqlState = 'HY000';
        }
        switch(this.status){
            case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$connection_status$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["CONNECTING"]:
            case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$connection_status$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AUTHENTICATING"]:
   ...
   */ fatalError(err, avoidThrowError) {
        ...
        const mustThrowError = this.status !== __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$connection_status$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["CONNECTING"];
        this.status = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$connection_status$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TERMINATING_SOCKET"];
   ...
   */ changeTransaction(cmdParam, resolve, reject) {
        if (this.status >= __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$connection_status$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TERMINATING"]) {
            const err = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createFatalError"]('Cannot execute new commands: connection closed', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_CMD_CONNECTION_CLOSED, this.info, '08S01', cmdParam.sql);
            this._logAndReject(reject, err);
            return;
        }
        //Command in progress => must execute the query,
        //or if no command in progress, can rely on status to know if a query is needed
        if (this.receiveQueue.peekFront() || this.info.status & __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$server$2d$status$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["STATUS_IN_TRANS"]) {
            const cmd = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$query$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](resolve, this._logAndReject.bind(this, reject), this.opts, cmdParam);
            this.addCommand(cmd, true);
        } else resolve();
    }
    changeUser(cmdParam, resolve, reject) {
        if (!this.info.isMariaDB()) {
            const err = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createError"]('method changeUser not available for MySQL server due to Bug #83472', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_MYSQL_CHANGE_USER_BUG, this.info, '0A000');
            this._logAndReject(reject, err);
            return;
        }
        if (this.status < __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$connection_status$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TERMINATING"]) {
        ...
        if (cmdParam.opts && cmdParam.opts.collation && typeof cmdParam.opts.collation === 'string') {
            ...
            cmdParam.opts.collation = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$collations$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].fromName(cmdParam.opts.collation.toUpperCase());
            if (cmdParam.opts.collation === undefined) return reject(new RangeError(`Unknown collation '${val}'`));
        }
        this.addCommand(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$change$2d$user$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](cmdParam, this.opts, (res)=>{
            if (conn.status < __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$connection_status$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TERMINATING"] && conn.opts.pipelining) conn.addCommand = conn.addCommandEnablePipeline;
    ...
    query(cmdParam, resolve, reject) {
        if (!cmdParam.sql) return reject(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createError"]('sql parameter is mandatory', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_UNDEFINED_SQL, this.info, 'HY000', null, false, cmdParam.stack));
        const cmd = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$query$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](resolve, (err)=>this._logAndReject(reject, err), this.opts, cmdParam);
        this.addCommand(cmd, true);
    }
    prepare(cmdParam, resolve, reject) {
        if (!cmdParam.sql) {
            reject(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createError"]('sql parameter is mandatory', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_UNDEFINED_SQL, this.info, 'HY000'));
            return;
        }
        ...
        const cmd = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$prepare$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](resolve, (err)=>this._logAndReject(reject, err), this.opts, cmdParam, this);
        this.addCommand(cmd, true);
    }
    prepareExecute(cmdParam, resolve, reject) {
        ...
        if (this.opts.pipelining && this.info.isMariaDB() && this.info.hasMinVersion(10, 2, 4)) {
            ...
            if (!hasStreamingValue) {
                let nbExecute = 0;
                const executeCommand = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$execute$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"]((res)=>{
                    if (nbExecute++ === 0) {
                ...
                const cmd = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$prepare$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"]((prep)=>{
        ...
        const cmd = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$prepare$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"]((prepare)=>{
    ...
    importFile(cmdParam, resolve, reject) {
        ...
        if (!cmdParam || !cmdParam.file) {
            return reject(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createError"]('SQL file parameter is mandatory', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_MISSING_SQL_PARAMETER, conn.info, 'HY000', null, false, cmdParam.stack));
        }
        const prevAddCommand = this.addCommand.bind(conn);
        this.waitingAuthenticationQueue = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$denque$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"]();
        this.addCommand = this.addCommandQueue;
        const tmpQuery = function(sql, resolve, reject) {
            const cmd = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$query$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](resolve, (err)=>{
                if (conn.opts.logger.error) conn.opts.logger.error(err);
                reject(err);
            }, conn.opts, {
                sql: sql,
        ...
        return (cmdParam.skipDbCheck ? Promise.resolve() : new Promise(tmpQuery.bind(conn, 'SELECT DATABASE() as db'))).then((res)=>{
            ...
            if (cmdParam.skipDbCheck && !conn.opts.database || !cmdParam.skipDbCheck && !cmdParam.database && !prevDatabase) {
                return reject(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createError"]('Database parameter is not set and no database is selected', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_MISSING_DATABASE_PARAMETER, conn.info, 'HY000', null, false, cmdParam.stack));
            }
            ...
            return searchDbPromise.then(()=>{
                const endingFunction = ()=>{
                    if (conn.status < __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$connection_status$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TERMINATING"]) {
                        conn.addCommand = conn.addCommandEnable.bind(conn);
                        if (conn.status < __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$connection_status$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TERMINATING"] && conn.opts.pipelining) {
                ...
                return __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$fs__$5b$external$5d$__$28$node$3a$fs$2c$__cjs$29$__["promises"].open(cmdParam.file, 'r').then(async (fd)=>{
                    const buf = {
                    ...
                    while(!cmdError){
                        try {
                            ...
                            if (res.bytesRead === 0) {
                                ...
                                const queries = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$parse$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseQueries"])(buf);
                            ...
                            return reject(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createError"](e.message, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_SQL_FILE_ERROR, conn.info, 'HY000', null, false, cmdParam.stack));
                        }
                    }
                    if (cmdError) {
                        endingFunction();
                    ...
                    endingFunction();
                    if (err.code === 'ENOENT') {
                        return reject(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createError"](`SQL file parameter '${cmdParam.file}' doesn't exists`, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_MISSING_SQL_FILE, conn.info, 'HY000', null, false, cmdParam.stack));
                    }
                    return reject(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createError"](err.message, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_SQL_FILE_ERROR, conn.info, 'HY000', null, false, cmdParam.stack));
                });
            });
        });
    }
   ...
   */ redirect(value, resolve) {
        if (this.opts.permitRedirect && value) {
            ...
            if (this.receiveQueue.length <= 1 && (this.info.status & __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$server$2d$status$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["STATUS_IN_TRANS"]) === 0) {
                ...
                const redirectOpts = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$config$2f$connection$2d$options$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].parseOptionDataType(options);
                const finalRedirectOptions = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$config$2f$connection$2d$options$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](Object.assign({}, this.opts, redirectOpts));
                const conn = new Connection(finalRedirectOptions);
                conn.connect().then((async function() {
                    await new Promise(this.end.bind(this, {}));
                    this.status = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$connection_status$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["CONNECTED"];
                    this.info = conn.info;
                    this.opts = conn.opts;
    ...
    _closePrepare(prepareResultPacket) {
        this.addCommand(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$close$2d$prepare$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"]({}, ()=>{}, ()=>{}, prepareResultPacket), false);
    }
...
"[project]/node_modules/mariadb/lib/cmd/stream.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 * see : https://mariadb.com/kb/en/library/com_query/
 */ class Stream extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$query$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"] {
...
"[project]/node_modules/mariadb/lib/connection-promise.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$stream$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/cmd/stream.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/misc/errors.js [app-route] (ecmascript)");
//  SPDX-License-Identifier: LGPL-2.1-or-later
//  Copyright (c) 2015-2025 MariaDB Corporation Ab
'use strict';
 ...
 */ class ConnectionPromise {
   ...
   */ queryStream(sql, values) {
        const cmdParam = paramSetter(sql, values);
        this.#capture(cmdParam);
        const cmd = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$stream$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](cmdParam, this.#conn.opts, this.#conn.socket);
        if (this.#conn.opts.logger.error) cmd.on('error', this.#conn.opts.logger.error);
        this.#conn.addCommand(cmd, true);
        return cmd.inStream;
    }
   ...
   */ importFile(opts) {
        if (!opts || !opts.file) {
            return Promise.reject(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createError"]('SQL file parameter is mandatory', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_MISSING_SQL_PARAMETER, this.#conn.info, 'HY000', null, false, null));
        }
...
const __TURBOPACK__default__export__ = ConnectionPromise;
...
"[project]/node_modules/mariadb/lib/pool.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/misc/errors.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/misc/utils.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$connection$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/connection.js [app-route] (ecmascript)");
//  SPDX-License-Identifier: LGPL-2.1-or-later
//  Copyright (c) 2015-2025 MariaDB Corporation Ab
'use strict';
;
...
;
;
class Pool extends __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$events__$5b$external$5d$__$28$node$3a$events$2c$__cjs$29$__["EventEmitter"] {
    opts;
    #closed = false;
    ...
    #idleConnections;
    #activeConnections = {};
    #requests = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$denque$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"]();
    ...
    constructor(options){
        super();
        this.opts = options;
        this.#idleConnections = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$denque$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](null, {
   ...
   */ _onConnectionCreationError(err, timeoutEnd) {
        ...
        let error;
        if (!this.#initialized) {
            error = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createError"](`Error during pool initialization`, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_POOL_NOT_INITIALIZED, null, null, null, false, null, null, err);
        } else {
            error = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createError"](`Pool fails to create connection`, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_POOL_NO_CONNECTION, null, null, null, false, null, null, err);
        }
   ...
   */ _createPoolConnection(onSuccess, onError, timeoutEnd) {
        ...
        const connectionOpts = Object.assign({}, this.opts.connOptions, {
            connectTimeout: Math.max(1, Math.min(timeoutEnd - Date.now(), this.opts.connOptions.connectTimeout || Number.MAX_SAFE_INTEGER))
        });
        const conn = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$connection$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](connectionOpts);
        this.#connectionCreationTask = null;
   ...
   */ _prepareNewConnection(conn, onSuccess, onError) {
        ...
        if (this.#closed) {
            ...
            onError(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createFatalError"]('Cannot create new connection to pool, pool closed', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_ADD_CONNECTION_CLOSED_POOL));
            return;
        }
   ...
   */ _handleConnectionCreationError(err, onSuccess, onError, timeoutEnd) {
        ...
        this.#connectionCreationTask = setTimeout(()=>this._createPoolConnection(onSuccess, onError, timeoutEnd), Math.min(500, timeoutEnd - Date.now()));
    }
    /**
   ...
   */ _rejectTimedOutRequest(request, currentTime) {
        ...
        let error;
        if (timeoutCause) {
            error = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createError"](`pool failed to retrieve a connection from pool${this._errorMsgAddon()}`, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_GET_CONNECTION_TIMEOUT, null, 'HY000', null, false, request.stack, null, timeoutCause);
        } else {
            // Create an appropriate error message with pool state information
            error = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createError"](`pool timeout: failed to retrieve a connection from pool after ${waitTime}ms${this._errorMsgAddon()}`, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_GET_CONNECTION_TIMEOUT, null, 'HY000', null, false, request.stack, null, null);
        }
   ...
   */ _removeIdleConnections() {
    ...
    _shouldCreateMoreConnections() {
        ...
        return !this.#connectionInCreation && (needsMinimumIdle || needsConnectionsForRequests) && hasCapacity && !this.#closed;
    }
    /**
   ...
   */ taskQueueSize() {
    ...
    escape(value) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["escape"](this.opts.connOptions, this._searchInfo(), value);
    }
    escapeId(value) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["escapeId"](this.opts.connOptions, this._searchInfo(), value);
    }
    //*****************************************************************
    // promise methods
    //*****************************************************************
   ...
   */ getConnection(cmdParam, callback) {
        ...
        if (this.#closed) {
            const err = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createError"]('pool is closed', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_POOL_ALREADY_CLOSED, null, 'HY000', cmdParam === null ? null : cmdParam.sql, false, cmdParam.stack);
            callback(err);
            return;
        }
        this._acquireIdleConnection((err, conn)=>{
            ...
            if (this.#closed) {
                callback(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createError"]('Cannot add request to pool, pool is closed', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_POOL_ALREADY_CLOSED, null, 'HY000', cmdParam === null ? null : cmdParam.sql, false, cmdParam.stack));
                return;
            }
   ...
   */ end() {
        if (this.#closed) {
            return Promise.reject(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createError"]('pool is already closed', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_POOL_ALREADY_CLOSED));
        }
        this.#closed = true;
        clearInterval(this.#unusedConnectionRemoverId);
        ...
        if (!this.#requests.isEmpty()) {
            const err = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createError"]('pool is ending, connection request aborted', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_CLOSING_POOL, null, 'HY000', null, false, cmdParam.stack);
            let task;
...
"[project]/node_modules/mariadb/lib/pool-promise.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$events__$5b$external$5d$__$28$node$3a$events$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/node:events [external] (node:events, cjs)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$pool$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/pool.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$connection$2d$promise$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/connection-promise.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/misc/errors.js [app-route] (ecmascript)");
//  SPDX-License-Identifier: LGPL-2.1-or-later
//  Copyright (c) 2015-2025 MariaDB Corporation Ab
'use strict';
...
class PoolPromise extends __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$events__$5b$external$5d$__$28$node$3a$events$2c$__cjs$29$__["EventEmitter"] {
    #pool;
    constructor(options){
        super();
        this.#pool = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$pool$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](options);
        const poolPromise = this;
        this.#pool._onNewConnection = (conn)=>{
            try {
                poolPromise.emit('connection', new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$connection$2d$promise$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](conn));
            } catch (err) {
        ...
        return new Promise((resolve, reject)=>{
            this.#pool.getConnection(cmdParam, (err, baseConn)=>{
                if (err) {
                    ...
                    const conn = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$connection$2d$promise$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](baseConn);
   ...
   * @param values  object / array of placeholder values (not mandatory)
   */ query(sql, values) {
        const cmdParam = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$connection$2d$promise$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["paramSetter"])(sql, values);
        if (this.#pool.opts.connOptions.trace) Error.captureStackTrace(cmdParam);
        return new Promise((resolve, reject)=>{
   ...
   */ importFile(opts) {
        if (!opts) {
            return Promise.reject(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createError"]('SQL file parameter is mandatory', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_MISSING_SQL_PARAMETER, null, 'HY000', null, false, null));
        }
        return new Promise((resolve, reject)=>{
...
const __TURBOPACK__default__export__ = PoolPromise;
}),
"[project]/node_modules/mariadb/lib/config/cluster-options.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const __TURBOPACK__default__export__ = ClusterOptions;
}),
"[project]/node_modules/mariadb/lib/config/pool-options.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class PoolOptions {
    constructor(opts){
        if (typeof opts === 'string') {
            opts = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$config$2f$connection$2d$options$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].parse(opts);
            // Set data type
        ...
        this.connOptions = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$config$2f$connection$2d$options$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](opts);
...
const __TURBOPACK__default__export__ = PoolOptions;
}),
"[project]/node_modules/mariadb/lib/connection-callback.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class ConnectionCallback {
   ...
   */ queryStream(sql, values) {
    ...
    static _QUERY_CMD(conn, cmdParam) {
        ...
        if (cmdParam.callback) {
            ...
            cmd = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$query$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](([rows, meta])=>{
                cmdParam.callback(null, rows, meta);
            }, cmdParam.callback, conn.opts, cmdParam);
        } else {
            cmd = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cmd$2f$query$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](()=>{}, ()=>{}, conn.opts, cmdParam);
        }
   ...
   */ importFile(opts, cb) {
        if (!opts || !opts.file) {
            if (cb) cb(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createError"]('SQL file parameter is mandatory', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_MISSING_SQL_PARAMETER, this.#conn.info, 'HY000', null, false, null));
            return;
        }
   ...
   */ debug(val) {
    ...
    connect(callback) {
        if (!callback) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createError"]('missing mandatory callback parameter', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_MISSING_PARAMETER, this.#conn.info);
        }
        switch(this.#conn.status){
            case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$connection_status$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NOT_CONNECTED"]:
            case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$connection_status$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["CONNECTING"]:
            case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$connection_status$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AUTHENTICATING"]:
            case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$connection_status$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["INIT_CMD"]:
                this.once('connect', callback);
                break;
            case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$connection_status$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["CONNECTED"]:
                callback.call(this);
                break;
            case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$connection_status$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TERMINATING"]:
            case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$connection_status$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TERMINATING_SOCKET"]:
            case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$const$2f$connection_status$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["CLOSED"]:
                callback.call(this, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createError"]('Connection closed', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["client"].ER_CONNECTION_ALREADY_CLOSED, this.#conn.info, '08S01', null, true));
                break;
        }
    }
    //*****************************************************************
...
const __TURBOPACK__default__export__ = ConnectionCallback;
}),
"[project]/node_modules/mariadb/lib/pool-callback.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$pool$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/pool.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/misc/errors.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$connection$2d$callback$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/connection-callback.js [app-route] (ecmascript)");
//  SPDX-License-Identifier: LGPL-2.1-or-later
//  Copyright (c) 2015-2025 MariaDB Corporation Ab
'use strict';
;
...
;
;
class PoolCallback extends __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$events__$5b$external$5d$__$28$node$3a$events$2c$__cjs$29$__["EventEmitter"] {
    #pool;
    constructor(options){
        super();
        this.#pool = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$pool$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](options);
        ...
        this.#pool._onNewConnection = (conn)=>{
            try {
                poolCallback.emit('connection', new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$connection$2d$callback$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](conn));
            } catch (err) {
            // ignore user errors in connection event handler
            }
        };
   ...
   */ getConnection(cb) {
        ...
        this.#pool.getConnection(cmdParam, (err, baseConn)=>{
            if (err) {
                ...
                const cc = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$connection$2d$callback$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](baseConn);
   ...
   * @param cb      callback
   */ query(sql, values, cb) {
        const cmdParam = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$connection$2d$callback$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"]._PARAM(this.#pool.opts.connOptions, sql, values, cb);
        this.#pool.getConnection(cmdParam, (err, baseConn)=>{
            if (err) {
                if (cmdParam.callback) cmdParam.callback(err);
            } else {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$connection$2d$callback$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"]._QUERY_CMD(baseConn, cmdParam);
            }
        });
    }
    /**
...
const __TURBOPACK__default__export__ = PoolCallback;
}),
"[project]/node_modules/mariadb/lib/filtered-cluster.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const __TURBOPACK__default__export__ = FilteredCluster;
}),
"[project]/node_modules/mariadb/lib/filtered-cluster-callback.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const __TURBOPACK__default__export__ = FilteredClusterCallback;
}),
"[project]/node_modules/mariadb/lib/cluster.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$config$2f$cluster$2d$options$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/config/cluster-options.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$config$2f$pool$2d$options$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/config/pool-options.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$pool$2d$callback$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/pool-callback.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$pool$2d$promise$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/pool-promise.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$filtered$2d$cluster$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/filtered-cluster.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$filtered$2d$cluster$2d$callback$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/filtered-cluster-callback.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$events__$5b$external$5d$__$28$node$3a$events$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/node:events [external] (node:events, cjs)");
//  SPDX-License-Identifier: LGPL-2.1-or-later
//  Copyright (c) 2015-2025 MariaDB Corporation Ab
'use strict';
 ...
 * @constructor
 */ class Cluster extends __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$events__$5b$external$5d$__$28$node$3a$events$2c$__cjs$29$__["default"] {
    #opts;
    #nodes = {};
    #cachedPatterns = {};
    #nodeCounter = 0;
    constructor(args){
        super();
        this.#opts = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$config$2f$cluster$2d$options$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](args);
    }
    /**
   ...
   */ add(id, config) {
        ...
        const options = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$config$2f$pool$2d$options$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](config);
   ...
   */ end() {
    ...
    of(pattern, selector) {
        return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$filtered$2d$cluster$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](this, pattern, selector);
    }
    _ofCallback(pattern, selector) {
        return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$filtered$2d$cluster$2d$callback$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](this, pattern, selector);
    }
    /**
   ...
   */ _getConnection(pattern, selector, remainingRetry, avoidNodeKey, lastError) {
    ...
    _createPool(options) {
        const pool = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$pool$2d$promise$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](options);
        pool.on('error', (err)=>{});
        return pool;
    }
    _createPoolCallback(options) {
        const pool = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$pool$2d$callback$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](options);
        pool.on('error', (err)=>{});
        return pool;
    }
    /**
   ...
   */ _handleNodeFailure(nodeKey, nodeList) {
        ...
        if (cluster.#opts.removeNodeErrorCount && node.errorCount >= cluster.#opts.removeNodeErrorCount && cluster.#nodes[nodeKey]) {
            ...
            if (node instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$pool$2d$callback$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"]) {
                node.end(()=>{
...
const __TURBOPACK__default__export__ = Cluster;
}),
"[project]/node_modules/mariadb/promise.js [app-route] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$check$2d$node$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/check-node.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$connection$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/connection.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$connection$2d$promise$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/connection-promise.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$pool$2d$promise$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/pool-promise.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cluster$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/cluster.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$config$2f$connection$2d$options$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/config/connection-options.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$config$2f$pool$2d$options$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/config/pool-options.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$config$2f$cluster$2d$options$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/config/cluster-options.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$misc$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mariadb/lib/misc/errors.js [app-route] (ecmascript)");
...
;
;
const version = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$package$2e$json$2e5b$json$5d2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].version;
;
function defaultOptions(opts) {
    const connOpts = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$config$2f$connection$2d$options$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](opts);
    const res = {};
...
function createConnection(opts) {
    try {
        const options = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$config$2f$connection$2d$options$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](opts);
        const conn = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$connection$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](options);
        const connPromise = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$connection$2d$promise$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](conn);
...
function createPool(opts) {
    const options = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$config$2f$pool$2d$options$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](opts);
    const pool = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$pool$2d$promise$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](options);
...
function createPoolCluster(opts) {
    const options = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$config$2f$cluster$2d$options$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](opts);
    return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mariadb$2f$lib$2f$cluster$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](options);
}
...
//# sourceMappingURL=node_modules_mariadb_0y8w49w._.js.map